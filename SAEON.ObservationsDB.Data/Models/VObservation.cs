...
namespace SAEON.ObservationsDB.Data{
    ...
    public partial class VObservation : ReadOnlyRecord<VObservation>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("vObservation", TableType.View, DataService.GetInstance("SqlDataProvider"));
                ...
                DataService.Providers["SqlDataProvider"].AddSchema("vObservation",schema);
            }
        }
        #endregion
