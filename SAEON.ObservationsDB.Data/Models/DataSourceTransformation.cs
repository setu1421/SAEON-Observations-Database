...
namespace SAEON.ObservationsDB.Data
{
	...
	public partial class DataSourceTransformation : ActiveRecord<DataSourceTransformation>, IActiveRecord
	{
		...
		{
			return new SAEON.ObservationsDB.Data.DataLogCollection().Where(DataLog.Columns.DataSourceTransformationID, Id).Load();
		}
		#endregion
		...
		/// 
		/// </summary>
		public SAEON.ObservationsDB.Data.TransformationType TransformationType
		{
			get { return SAEON.ObservationsDB.Data.TransformationType.FetchByID(this.TransformationTypeID); }
