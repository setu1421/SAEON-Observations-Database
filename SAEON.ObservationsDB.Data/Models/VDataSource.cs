...
namespace SAEON.ObservationsDB.Data{
    ...
    public partial class VDataSource : ReadOnlyRecord<VDataSource>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("vDataSource", TableType.View, DataService.GetInstance("SqlDataProvider"));
                ...
                DataService.Providers["SqlDataProvider"].AddSchema("vDataSource",schema);
            }
        }
        #endregion
