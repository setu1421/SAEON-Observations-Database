...
namespace SAEON.ObservationsDB.Data
{
	...
	public partial class AspnetPersonalizationPerUser : ActiveRecord<AspnetPersonalizationPerUser>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("aspnet_PersonalizationPerUser", TableType.Table, DataService.GetInstance("SqlDataProvider"));
				...
				DataService.Providers["SqlDataProvider"].AddSchema("aspnet_PersonalizationPerUser",schema);
			}
		}
		#endregion
