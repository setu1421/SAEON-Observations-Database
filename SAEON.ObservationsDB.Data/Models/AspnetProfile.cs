...
namespace SAEON.ObservationsDB.Data
{
	...
	public partial class AspnetProfile : ActiveRecord<AspnetProfile>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("aspnet_Profile", TableType.Table, DataService.GetInstance("SqlDataProvider"));
				...
				DataService.Providers["SqlDataProvider"].AddSchema("aspnet_Profile",schema);
			}
		}
		#endregion
