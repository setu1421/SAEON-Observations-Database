...
namespace SAEON.ObservationsDB.Data{
    ...
    public partial class VUserInfo : ReadOnlyRecord<VUserInfo>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("vUserInfo", TableType.View, DataService.GetInstance("SqlDataProvider"));
                ...
                DataService.Providers["SqlDataProvider"].AddSchema("vUserInfo",schema);
            }
        }
        #endregion
