...
namespace SAEON.ObservationsDB.Data
{
    ...
    public partial class PhenomenonUOMController
    {
	    ...
	    public void Insert(Guid Id,Guid PhenomenonID,Guid UnitOfMeasureID,bool IsDefault)
	    {
	    ...
	    public void Update(Guid Id,Guid PhenomenonID,Guid UnitOfMeasureID,bool IsDefault)
	    {
		    PhenomenonUOM item = new PhenomenonUOM();
	        item.MarkOld();
	        item.IsLoaded = true;
