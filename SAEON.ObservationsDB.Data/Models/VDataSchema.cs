...
namespace SAEON.ObservationsDB.Data{
    ...
    public partial class VDataSchema : ReadOnlyRecord<VDataSchema>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("vDataSchema", TableType.View, DataService.GetInstance("SqlDataProvider"));
                ...
                DataService.Providers["SqlDataProvider"].AddSchema("vDataSchema",schema);
            }
        }
        #endregion
