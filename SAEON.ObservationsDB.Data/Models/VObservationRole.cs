...
namespace SAEON.ObservationsDB.Data{
    ...
    public partial class VObservationRole : ReadOnlyRecord<VObservationRole>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("vObservationRoles", TableType.View, DataService.GetInstance("SqlDataProvider"));
                ...
                DataService.Providers["SqlDataProvider"].AddSchema("vObservationRoles",schema);
            }
        }
        #endregion
