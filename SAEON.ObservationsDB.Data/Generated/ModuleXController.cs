...
namespace SAEON.ObservationsDB.Data
{
    ...
    public partial class ModuleXController
    {
	    ...
	    public void Insert(Guid Id,string Name,string Description,string Url,int Icon,Guid? ModuleID,int? IOrder)
	    {
	    ...
	    public void Update(Guid Id,string Name,string Description,string Url,int Icon,Guid? ModuleID,int? IOrder)
	    {
		    ModuleX item = new ModuleX();
	        item.MarkOld();
	        item.IsLoaded = true;
