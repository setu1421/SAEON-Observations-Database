...
namespace SAEON.ObservationsDB.Data
{
	...
	public partial class ModuleX : ActiveRecord<ModuleX>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Module", TableType.Table, DataService.GetInstance("SqlDataProvider"));
				...
				DataService.Providers["SqlDataProvider"].AddSchema("Module",schema);
			}
		}
		#endregion
		...
		public SAEON.ObservationsDB.Data.ModuleXCollection ChildModuleXRecords()
		{
			return new SAEON.ObservationsDB.Data.ModuleXCollection().Where(ModuleX.Columns.ModuleID, Id).Load();
		}
		public SAEON.ObservationsDB.Data.RoleModuleCollection RoleModuleRecords()
		{
			return new SAEON.ObservationsDB.Data.RoleModuleCollection().Where(RoleModule.Columns.ModuleID, Id).Load();
		}
		#endregion
		...
		/// 
		/// </summary>
		public SAEON.ObservationsDB.Data.ModuleX ParentModuleX
		{
			get { return SAEON.ObservationsDB.Data.ModuleX.FetchByID(this.ModuleID); }
