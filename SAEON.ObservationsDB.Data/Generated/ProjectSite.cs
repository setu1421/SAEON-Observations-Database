...
namespace SAEON.ObservationsDB.Data
{
	...
	public partial class ProjectSite : ActiveRecord<ProjectSite>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("ProjectSite", TableType.Table, DataService.GetInstance("SqlDataProvider"));
				...
				DataService.Providers["SqlDataProvider"].AddSchema("ProjectSite",schema);
			}
		}
		#endregion
		...
		{
			return new SAEON.ObservationsDB.Data.StationCollection().Where(Station.Columns.ProjectSiteID, Id).Load();
		}
		#endregion
