...
namespace SAEON.ObservationsDB.Data
{
	...
	public partial class AspnetUsersInRole : ActiveRecord<AspnetUsersInRole>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("aspnet_UsersInRoles", TableType.Table, DataService.GetInstance("SqlDataProvider"));
				...
				DataService.Providers["SqlDataProvider"].AddSchema("aspnet_UsersInRoles",schema);
			}
		}
		#endregion
