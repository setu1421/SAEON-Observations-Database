...
namespace SAEON.ObservationsDB.Data
{
    ...
    public partial class TransformationType : ActiveRecord<TransformationType>, IActiveRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("TransformationType", TableType.Table, DataService.GetInstance("SqlDataProvider"));
                ...
                DataService.Providers["SqlDataProvider"].AddSchema("TransformationType",schema);
            }
        }
        #endregion
        ...
        {
            return new SAEON.ObservationsDB.Data.DataSourceTransformationCollection().Where(DataSourceTransformation.Columns.TransformationTypeID, Id).Load();
        }
        #endregion
