...
#pragma warning restore VSTHRD200 // Use "Async" suffix for async methods
        ...
        public PartialViewResult UpdateLocationsSelected(List<string> locations)
        {
            using (SAEONLogs.MethodCall(GetType()))
            {
                try
                {
                    ...
                    SessionModel = model;
                    SAEONLogs.Verbose("LocationsSelected: {@LocationsSelected}", model.LocationsSelected);
                    SAEONLogs.Verbose("Organisations: {Organisations}", model.Organisations);
                    SAEONLogs.Verbose("Sites: {Sites}", model.Sites);
                    SAEONLogs.Verbose("Stations: {Stations}", model.Stations);
        ...
        public PartialViewResult UpdateFeaturesSelected(List<string> features)
        {
            using (SAEONLogs.MethodCall(GetType()))
            {
                try
                {
                    SAEONLogs.Verbose("Features: {Features}", features);
                    var model = SessionModel;
                    // Clear all
                    ...
                    SessionModel = model;
                    SAEONLogs.Verbose("FeaturesSelected: {@FeaturesSelected}", model.FeaturesSelected);
                    SAEONLogs.Verbose("Phenomena: {Phenomena}", model.Phenomena);
                    SAEONLogs.Verbose("Offerings: {Offerings}", model.Offerings);
                    SAEONLogs.Verbose("Units: {Units}", model.Units);
