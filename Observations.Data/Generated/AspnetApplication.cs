...
namespace Observations.Data
{
	...
	public partial class AspnetApplication : ActiveRecord<AspnetApplication>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("aspnet_Applications", TableType.Table, DataService.GetInstance("SqlDataProvider"));
				...
				DataService.Providers["SqlDataProvider"].AddSchema("aspnet_Applications",schema);
			}
		}
		#endregion
		...
		public Observations.Data.AspnetUserCollection AspnetUsers()
		{
			return new Observations.Data.AspnetUserCollection().Where(AspnetUser.Columns.ApplicationId, ApplicationId).Load();
		}
		public Observations.Data.AspnetMembershipCollection AspnetMembershipRecords()
		{
			return new Observations.Data.AspnetMembershipCollection().Where(AspnetMembership.Columns.ApplicationId, ApplicationId).Load();
		}
		public Observations.Data.AspnetRoleCollection AspnetRoles()
		{
			return new Observations.Data.AspnetRoleCollection().Where(AspnetRole.Columns.ApplicationId, ApplicationId).Load();
		}
		public Observations.Data.AspnetPathCollection AspnetPaths()
		{
			return new Observations.Data.AspnetPathCollection().Where(AspnetPath.Columns.ApplicationId, ApplicationId).Load();
		}
		#endregion
