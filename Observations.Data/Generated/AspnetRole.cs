...
namespace Observations.Data
{
	...
	public partial class AspnetRole : ActiveRecord<AspnetRole>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("aspnet_Roles", TableType.Table, DataService.GetInstance("SqlDataProvider"));
				...
				DataService.Providers["SqlDataProvider"].AddSchema("aspnet_Roles",schema);
			}
		}
		#endregion
		...
		{
			return new Observations.Data.RoleModuleCollection().Where(RoleModule.Columns.RoleId, RoleId).Load();
		}
		public Observations.Data.DataSourceRoleCollection DataSourceRoleRecords()
		{
			return new Observations.Data.DataSourceRoleCollection().Where(DataSourceRole.Columns.RoleId, RoleId).Load();
		}
		public Observations.Data.AspnetUsersInRoleCollection AspnetUsersInRoles()
		{
			return new Observations.Data.AspnetUsersInRoleCollection().Where(AspnetUsersInRole.Columns.RoleId, RoleId).Load();
		}
		#endregion
		...
		public Observations.Data.AspnetUserCollection GetAspnetUserCollection() { return AspnetRole.GetAspnetUserCollection(this.RoleId); }
		public static Observations.Data.AspnetUserCollection GetAspnetUserCollection(Guid varRoleId)
		{
