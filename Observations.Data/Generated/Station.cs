...
namespace Observations.Data
{
	...
	public partial class Station : ActiveRecord<Station>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Station", TableType.Table, DataService.GetInstance("SqlDataProvider"));
				...
				DataService.Providers["SqlDataProvider"].AddSchema("Station",schema);
			}
		}
		#endregion
		...
		{
			return new Observations.Data.SensorProcedureCollection().Where(SensorProcedure.Columns.StationID, Id).Load();
		}
		#endregion
		...
		/// 
		/// </summary>
		public Observations.Data.ProjectSite ProjectSite
		{
			get { return Observations.Data.ProjectSite.FetchByID(this.ProjectSiteID); }
