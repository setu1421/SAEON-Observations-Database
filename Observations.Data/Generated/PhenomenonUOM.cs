...
namespace Observations.Data
{
	...
	public partial class PhenomenonUOM : ActiveRecord<PhenomenonUOM>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("PhenomenonUOM", TableType.Table, DataService.GetInstance("SqlDataProvider"));
				...
				DataService.Providers["SqlDataProvider"].AddSchema("PhenomenonUOM",schema);
			}
		}
		#endregion
		...
		{
			return new Observations.Data.DataSourceTransformationCollection().Where(DataSourceTransformation.Columns.PhenomenonUOMID, Id).Load();
		}
		public Observations.Data.DataLogCollection DataLogRecords()
		{
			return new Observations.Data.DataLogCollection().Where(DataLog.Columns.PhenonmenonUOMID, Id).Load();
		}
		public Observations.Data.ObservationCollection ObservationRecords()
		{
			return new Observations.Data.ObservationCollection().Where(Observation.Columns.PhenonmenonUOMID, Id).Load();
		}
		#endregion
		...
		/// 
		/// </summary>
		public Observations.Data.UnitOfMeasure UnitOfMeasure
		{
			get { return Observations.Data.UnitOfMeasure.FetchByID(this.UnitOfMeasureID); }
