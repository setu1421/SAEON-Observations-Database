...
namespace Observations.Data
{
	...
	public partial class Phenomenon : ActiveRecord<Phenomenon>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Phenomenon", TableType.Table, DataService.GetInstance("SqlDataProvider"));
				...
				DataService.Providers["SqlDataProvider"].AddSchema("Phenomenon",schema);
			}
		}
		#endregion
		...
		public Observations.Data.PhenomenonUOMCollection PhenomenonUOMRecords()
		{
			return new Observations.Data.PhenomenonUOMCollection().Where(PhenomenonUOM.Columns.PhenomenonID, Id).Load();
		}
		public Observations.Data.PhenomenonOfferingCollection PhenomenonOfferingRecords()
		{
			return new Observations.Data.PhenomenonOfferingCollection().Where(PhenomenonOffering.Columns.PhenomenonID, Id).Load();
		}
		public Observations.Data.SensorProcedureCollection SensorProcedureRecords()
		{
			return new Observations.Data.SensorProcedureCollection().Where(SensorProcedure.Columns.PhenomenonID, Id).Load();
		}
		public Observations.Data.DataSourceTransformationCollection DataSourceTransformationRecords()
		{
			return new Observations.Data.DataSourceTransformationCollection().Where(DataSourceTransformation.Columns.PhenomenonID, Id).Load();
		}
		#endregion
