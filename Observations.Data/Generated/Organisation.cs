...
namespace Observations.Data
{
	...
	public partial class Organisation : ActiveRecord<Organisation>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Organisation", TableType.Table, DataService.GetInstance("SqlDataProvider"));
				...
				DataService.Providers["SqlDataProvider"].AddSchema("Organisation",schema);
			}
		}
		#endregion
		...
		{
			return new Observations.Data.ProjectSiteCollection().Where(ProjectSite.Columns.OrganisationID, Id).Load();
		}
		#endregion
