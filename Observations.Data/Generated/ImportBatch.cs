...
namespace Observations.Data
{
	...
	public partial class ImportBatch : ActiveRecord<ImportBatch>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("ImportBatch", TableType.Table, DataService.GetInstance("SqlDataProvider"));
				...
				DataService.Providers["SqlDataProvider"].AddSchema("ImportBatch",schema);
			}
		}
		#endregion
		...
		{
			return new Observations.Data.DataLogCollection().Where(DataLog.Columns.ImportBatchID, Id).Load();
		}
		public Observations.Data.ObservationCollection ObservationRecords()
		{
			return new Observations.Data.ObservationCollection().Where(Observation.Columns.ImportBatchID, Id).Load();
		}
		#endregion
