...
namespace Observations.Data
{
	...
	public partial class PhenomenonOffering : ActiveRecord<PhenomenonOffering>, IActiveRecord
	{
		...
		{
			return new Observations.Data.DataSourceTransformationCollection().Where(DataSourceTransformation.Columns.PhenomenonOfferingID, Id).Load();
		}
		public Observations.Data.DataLogCollection DataLogRecords()
		{
			return new Observations.Data.DataLogCollection().Where(DataLog.Columns.PhenomenonOfferingID, Id).Load();
		}
		public Observations.Data.ObservationCollection ObservationRecords()
		{
			return new Observations.Data.ObservationCollection().Where(Observation.Columns.PhenonmenonOfferingID, Id).Load();
		}
		#endregion
		...
		/// 
		/// </summary>
		public Observations.Data.Offering Offering
		{
			get { return Observations.Data.Offering.FetchByID(this.OfferingID); }
