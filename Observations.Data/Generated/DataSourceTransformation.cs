...
namespace Observations.Data
{
	...
	public partial class DataSourceTransformation : ActiveRecord<DataSourceTransformation>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("DataSourceTransformation", TableType.Table, DataService.GetInstance("SqlDataProvider"));
				...
				DataService.Providers["SqlDataProvider"].AddSchema("DataSourceTransformation",schema);
			}
		}
		#endregion
		...
		{
			return new Observations.Data.DataLogCollection().Where(DataLog.Columns.DataSourceTransformationID, Id).Load();
		}
		#endregion
		...
		{
			get { return Observations.Data.PhenomenonUOM.FetchByID(this.PhenomenonUOMID); }
		...
		/// 
		/// </summary>
		public Observations.Data.TransformationType TransformationType
		{
			get { return Observations.Data.TransformationType.FetchByID(this.TransformationTypeID); }
