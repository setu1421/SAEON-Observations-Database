...
namespace Observations.Data
{
	...
	public partial class DataLog : ActiveRecord<DataLog>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("DataLog", TableType.Table, DataService.GetInstance("SqlDataProvider"));
				...
				DataService.Providers["SqlDataProvider"].AddSchema("DataLog",schema);
			}
		}
		#endregion
		...
		/// 
		/// </summary>
		public Observations.Data.DataSourceTransformation DataSourceTransformation
		{
			get { return Observations.Data.DataSourceTransformation.FetchByID(this.DataSourceTransformationID); }
		...
		{
			get { return Observations.Data.PhenomenonOffering.FetchByID(this.PhenomenonOfferingID); }
		...
		/// 
		/// </summary>
		public Observations.Data.Status Status
		{
			get { return Observations.Data.Status.FetchByID(this.StatusID); }
