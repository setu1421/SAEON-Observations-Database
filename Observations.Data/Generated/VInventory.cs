...
namespace Observations.Data{
    ...
    public partial class VInventory : ReadOnlyRecord<VInventory>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("vInventory", TableType.View, DataService.GetInstance("SqlDataProvider"));
                ...
                DataService.Providers["SqlDataProvider"].AddSchema("vInventory",schema);
            }
        }
        #endregion
