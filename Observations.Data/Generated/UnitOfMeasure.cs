...
namespace Observations.Data
{
	...
	public partial class UnitOfMeasure : ActiveRecord<UnitOfMeasure>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("UnitOfMeasure", TableType.Table, DataService.GetInstance("SqlDataProvider"));
				...
				DataService.Providers["SqlDataProvider"].AddSchema("UnitOfMeasure",schema);
			}
		}
		#endregion
		...
		{
			return new Observations.Data.PhenomenonUOMCollection().Where(PhenomenonUOM.Columns.UnitOfMeasureID, Id).Load();
		}
		#endregion
