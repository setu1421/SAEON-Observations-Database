...
namespace Observations.Data
{
	...
	public partial class AspnetUser : ActiveRecord<AspnetUser>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("aspnet_Users", TableType.Table, DataService.GetInstance("SqlDataProvider"));
				...
				DataService.Providers["SqlDataProvider"].AddSchema("aspnet_Users",schema);
			}
		}
		#endregion
		...
		public Observations.Data.PhenomenonCollection PhenomenonRecords()
		{
			return new Observations.Data.PhenomenonCollection().Where(Phenomenon.Columns.UserId, UserId).Load();
		}
		public Observations.Data.ImportBatchCollection ImportBatchRecords()
		{
			return new Observations.Data.ImportBatchCollection().Where(ImportBatch.Columns.UserId, UserId).Load();
		}
		public Observations.Data.OfferingCollection OfferingRecords()
		{
			return new Observations.Data.OfferingCollection().Where(Offering.Columns.UserId, UserId).Load();
		}
		public Observations.Data.UnitOfMeasureCollection UnitOfMeasureRecords()
		{
			return new Observations.Data.UnitOfMeasureCollection().Where(UnitOfMeasure.Columns.UserId, UserId).Load();
		}
		public Observations.Data.SensorProcedureCollection SensorProcedureRecords()
		{
			return new Observations.Data.SensorProcedureCollection().Where(SensorProcedure.Columns.UserId, UserId).Load();
		}
		public Observations.Data.OrganisationCollection OrganisationRecords()
		{
			return new Observations.Data.OrganisationCollection().Where(Organisation.Columns.UserId, UserId).Load();
		}
		public Observations.Data.StationCollection StationRecords()
		{
			return new Observations.Data.StationCollection().Where(Station.Columns.UserId, UserId).Load();
		}
		public Observations.Data.AspnetMembershipCollection AspnetMembershipRecords()
		{
			return new Observations.Data.AspnetMembershipCollection().Where(AspnetMembership.Columns.UserId, UserId).Load();
		}
		public Observations.Data.ProjectSiteCollection ProjectSiteRecords()
		{
			return new Observations.Data.ProjectSiteCollection().Where(ProjectSite.Columns.UserId, UserId).Load();
		}
		public Observations.Data.AspnetProfileCollection AspnetProfileRecords()
		{
			return new Observations.Data.AspnetProfileCollection().Where(AspnetProfile.Columns.UserId, UserId).Load();
		}
		public Observations.Data.AspnetUsersInRoleCollection AspnetUsersInRoles()
		{
			return new Observations.Data.AspnetUsersInRoleCollection().Where(AspnetUsersInRole.Columns.UserId, UserId).Load();
		}
		public Observations.Data.DataLogCollection DataLogRecords()
		{
			return new Observations.Data.DataLogCollection().Where(DataLog.Columns.UserId, UserId).Load();
		}
		public Observations.Data.ObservationCollection ObservationRecords()
		{
			return new Observations.Data.ObservationCollection().Where(Observation.Columns.UserId, UserId).Load();
		}
		public Observations.Data.DataSourceCollection DataSourceRecords()
		{
			return new Observations.Data.DataSourceCollection().Where(DataSource.Columns.UserId, UserId).Load();
		}
		public Observations.Data.AspnetPersonalizationPerUserCollection AspnetPersonalizationPerUserRecords()
		{
			return new Observations.Data.AspnetPersonalizationPerUserCollection().Where(AspnetPersonalizationPerUser.Columns.UserId, UserId).Load();
		}
		#endregion
		...
		/// 
		/// </summary>
		public Observations.Data.AspnetApplication AspnetApplication
		{
			get { return Observations.Data.AspnetApplication.FetchByID(this.ApplicationId); }
		...
		public Observations.Data.AspnetRoleCollection GetAspnetRoleCollection() { return AspnetUser.GetAspnetRoleCollection(this.UserId); }
		public static Observations.Data.AspnetRoleCollection GetAspnetRoleCollection(Guid varUserId)
		{
