...
namespace Northwind{
    ...
    /// </summary>
    [Serializable]
    public partial class Summary_Of_Sales_By_QuarterCollection : ReadOnlyList<Summary_Of_Sales_By_Quarter, Summary_Of_Sales_By_QuarterCollection>
    {        
    ...
    /// </summary>
    [Serializable]
    public partial class Summary_Of_Sales_By_Quarter : ReadOnlyRecord<Summary_Of_Sales_By_Quarter>, IReadOnlyRecord
    {
        ...
        public Summary_Of_Sales_By_Quarter(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public Summary_Of_Sales_By_Quarter(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public Summary_Of_Sales_By_Quarter(string columnName, object columnValue)
        {
            SetSQLProps();
