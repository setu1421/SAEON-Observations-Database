...
namespace Northwind{
    ...
    /// </summary>
    [Serializable]
    public partial class Alphabetical_List_Of_ProductCollection : ReadOnlyList<Alphabetical_List_Of_Product, Alphabetical_List_Of_ProductCollection>
    {        
    ...
    /// </summary>
    [Serializable]
    public partial class Alphabetical_List_Of_Product : ReadOnlyRecord<Alphabetical_List_Of_Product>, IReadOnlyRecord
    {
        ...
        public Alphabetical_List_Of_Product(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public Alphabetical_List_Of_Product(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public Alphabetical_List_Of_Product(string columnName, object columnValue)
        {
            SetSQLProps();
