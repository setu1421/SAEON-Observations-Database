...
namespace Northwind{
    ...
    /// </summary>
    [Serializable]
    public partial class Quarterly_OrderCollection : ReadOnlyList<Quarterly_Order, Quarterly_OrderCollection>
    {        
    ...
    /// </summary>
    [Serializable]
    public partial class Quarterly_Order : ReadOnlyRecord<Quarterly_Order>, IReadOnlyRecord
    {
        ...
        public Quarterly_Order(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public Quarterly_Order(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public Quarterly_Order(string columnName, object columnValue)
        {
            SetSQLProps();
