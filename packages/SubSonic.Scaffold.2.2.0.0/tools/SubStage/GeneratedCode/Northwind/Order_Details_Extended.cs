...
namespace Northwind{
    ...
    /// </summary>
    [Serializable]
    public partial class Order_Details_ExtendedCollection : ReadOnlyList<Order_Details_Extended, Order_Details_ExtendedCollection>
    {        
    ...
    /// </summary>
    [Serializable]
    public partial class Order_Details_Extended : ReadOnlyRecord<Order_Details_Extended>, IReadOnlyRecord
    {
        ...
        public Order_Details_Extended(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public Order_Details_Extended(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public Order_Details_Extended(string columnName, object columnValue)
        {
            SetSQLProps();
