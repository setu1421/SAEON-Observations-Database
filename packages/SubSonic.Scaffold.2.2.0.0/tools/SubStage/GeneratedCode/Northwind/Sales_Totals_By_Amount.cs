...
namespace Northwind{
    ...
    /// </summary>
    [Serializable]
    public partial class Sales_Totals_By_AmountCollection : ReadOnlyList<Sales_Totals_By_Amount, Sales_Totals_By_AmountCollection>
    {        
    ...
    /// </summary>
    [Serializable]
    public partial class Sales_Totals_By_Amount : ReadOnlyRecord<Sales_Totals_By_Amount>, IReadOnlyRecord
    {
        ...
        public Sales_Totals_By_Amount(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public Sales_Totals_By_Amount(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public Sales_Totals_By_Amount(string columnName, object columnValue)
        {
            SetSQLProps();
