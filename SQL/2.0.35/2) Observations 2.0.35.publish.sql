...
GO
PRINT N'Creating [dbo].[Observation].[UX_Observation]...';

GO
ALTER TABLE [dbo].[Observation] WITH NOCHECK
    ADD CONSTRAINT [UX_Observation] UNIQUE NONCLUSTERED ([SensorID] ASC, [ValueDate] ASC, [RawValue] ASC, [PhenomenonOfferingID] ASC, [PhenomenonUOMID] ASC) ON [Observations]
