...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        INSERT INTO [dbo].[tmp_ms_xx_DataSourceTransformation] ([ID], [TransformationTypeID], [PhenomenonID], [PhenomenonOfferingID], [PhenomenonUOMID], [StartDate], [EndDate], [DataSourceID], [Definition], [NewPhenomenonOfferingID], [NewPhenomenonUOMID], [Rank], [UserId])
        SELECT   [ID],
...
ALTER TABLE [dbo].[Organisation]
    ADD [AddedAt]   DATETIME CONSTRAINT [DF_Organisation_AddedAt] DEFAULT GetDate() NULL,
