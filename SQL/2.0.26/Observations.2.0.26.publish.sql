...
GO
PRINT N'Dropping [dbo].[PK_AuditLog]...';


GO
ALTER TABLE [dbo].[AuditLog] DROP CONSTRAINT [PK_AuditLog];


GO
PRINT N'Dropping [dbo].[PK_DataLog]...';


GO
ALTER TABLE [dbo].[DataLog] DROP CONSTRAINT [PK_DataLog];


GO
PRINT N'Dropping [dbo].[PK_DataSchema]...';


GO
ALTER TABLE [dbo].[DataSchema] DROP CONSTRAINT [PK_DataSchema];


GO
PRINT N'Dropping [dbo].[PK_DataSource]...';
...
GO
PRINT N'Dropping [dbo].[PK_DataSourceRole]...';


GO
ALTER TABLE [dbo].[DataSourceRole] DROP CONSTRAINT [PK_DataSourceRole];


GO
PRINT N'Dropping [dbo].[PK_DataSourceTransformation]...';


GO
ALTER TABLE [dbo].[DataSourceTransformation] DROP CONSTRAINT [PK_DataSourceTransformation];


GO
PRINT N'Dropping [dbo].[PK_DataSourceType]...';


GO
ALTER TABLE [dbo].[DataSourceType] DROP CONSTRAINT [PK_DataSourceType];


GO
PRINT N'Dropping [dbo].[PK_Instrument]...';


GO
ALTER TABLE [dbo].[Instrument] DROP CONSTRAINT [PK_Instrument];


GO
PRINT N'Dropping [dbo].[PK_Instrument_DataSource]...';


GO
ALTER TABLE [dbo].[Instrument_DataSource] DROP CONSTRAINT [PK_Instrument_DataSource];


GO
PRINT N'Dropping [dbo].[PK_Instrument_Sensor]...';


GO
ALTER TABLE [dbo].[Instrument_Sensor] DROP CONSTRAINT [PK_Instrument_Sensor];


GO
PRINT N'Dropping [dbo].[PK_Offering]...';


GO
ALTER TABLE [dbo].[Offering] DROP CONSTRAINT [PK_Offering];


GO
PRINT N'Dropping [dbo].[PK_Organisation_Site]...';


GO
ALTER TABLE [dbo].[Organisation_Site] DROP CONSTRAINT [PK_Organisation_Site];


GO
PRINT N'Dropping [dbo].[PK_Organisation_Station]...';


GO
ALTER TABLE [dbo].[Organisation_Station] DROP CONSTRAINT [PK_Organisation_Station];


GO
PRINT N'Dropping [dbo].[PK_OrganisationRole]...';


GO
ALTER TABLE [dbo].[OrganisationRole] DROP CONSTRAINT [PK_OrganisationRole];


GO
PRINT N'Dropping [dbo].[PK_Phenomenon]...';


GO
ALTER TABLE [dbo].[Phenomenon] DROP CONSTRAINT [PK_Phenomenon];


GO
PRINT N'Dropping [dbo].[PK_PhenomenonOffering]...';


GO
ALTER TABLE [dbo].[PhenomenonOffering] DROP CONSTRAINT [PK_PhenomenonOffering];


GO
PRINT N'Dropping [dbo].[PK_PhenomenonUOM]...';


GO
ALTER TABLE [dbo].[PhenomenonUOM] DROP CONSTRAINT [PK_PhenomenonUOM];


GO
PRINT N'Dropping [dbo].[PK_Programme]...';
...
GO
PRINT N'Dropping [dbo].[PK_Project]...';


GO
ALTER TABLE [dbo].[Project] DROP CONSTRAINT [PK_Project];


GO
PRINT N'Dropping [dbo].[PK_Project_Station]...';


GO
ALTER TABLE [dbo].[Project_Station] DROP CONSTRAINT [PK_Project_Station];


GO
PRINT N'Dropping [dbo].[PK_SchemaColumn]...';


GO
ALTER TABLE [dbo].[SchemaColumn] DROP CONSTRAINT [PK_SchemaColumn];


GO
PRINT N'Dropping [dbo].[PK_SchemaColumnType]...';


GO
ALTER TABLE [dbo].[SchemaColumnType] DROP CONSTRAINT [PK_SchemaColumnType];


GO
PRINT N'Dropping [dbo].[PK_Sensor]...';


GO
ALTER TABLE [dbo].[Sensor] DROP CONSTRAINT [PK_Sensor];


GO
PRINT N'Dropping [dbo].[PK_Site]...';
...
GO
PRINT N'Dropping [dbo].[PKStation]...';


GO
ALTER TABLE [dbo].[Station] DROP CONSTRAINT [PKStation];


GO
PRINT N'Dropping [dbo].[PK_Station_Instrument]...';


GO
ALTER TABLE [dbo].[Station_Instrument] DROP CONSTRAINT [PK_Station_Instrument];


GO
PRINT N'Dropping [dbo].[PK_Status]...';
...
GO
PRINT N'Dropping [dbo].[PK_StatusReason]...';


GO
ALTER TABLE [dbo].[StatusReason] DROP CONSTRAINT [PK_StatusReason];


GO
PRINT N'Dropping [dbo].[PK_TransformationType]...';


GO
ALTER TABLE [dbo].[TransformationType] DROP CONSTRAINT [PK_TransformationType];


GO
PRINT N'Dropping [dbo].[PK_UnitOfMeasure]...';


GO
ALTER TABLE [dbo].[UnitOfMeasure] DROP CONSTRAINT [PK_UnitOfMeasure];
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        ...
        INSERT INTO [dbo].[tmp_ms_xx_ImportBatch] ([ID], [Code], [DataSourceID], [ImportDate], [Status], [UserId], [FileName], [LogFileName], [Comment], [StatusID], [StatusReasonID], [Problems], [SourceFile], [Pass1File], [Pass2File], [Pass3File], [Pass4File], [AddedAt], [UpdatedAt])
        SELECT   [ID],
                 [Code],
                 [DataSourceID],
                 [ImportDate],
...
--ALTER TABLE [dbo].[Observation] ADD CONSTRAINT [PK_Observation] PRIMARY KEY NONCLUSTERED ([ID] ASC) ON [Observations]
--ALTER TABLE [dbo].[Observation] ADD CONSTRAINT [UX_Observation] UNIQUE NONCLUSTERED ([SensorID] ASC, [ImportBatchID] ASC, [ValueDate] ASC, [PhenomenonOfferingID] ASC, [PhenomenonUOMID] ASC) ON [Observations]
--CREATE CLUSTERED INDEX [CX_Observation] ON [dbo].[Observation]([AddedAt] ASC) ON [Observations]
...
IF EXISTS (SELECT TOP 1 1 
           FROM   [dbo].[AuditLog])
    BEGIN
        INSERT INTO [dbo].[tmp_ms_xx_AuditLog] ([ID], [Description], [UserId], [AddedAt], [UpdatedAt])
        SELECT   [ID],
                 [Description],
                 [UserId],
                 [AddedAt],
...
IF EXISTS (SELECT TOP 1 1 
           FROM   [dbo].[DataSchema])
    BEGIN
        INSERT INTO [dbo].[tmp_ms_xx_DataSchema] ([ID], [Code], [Name], [Description], [DataSourceTypeID], [IgnoreFirst], [HasHeaderRow], [IgnoreLast], [Condition], [DataSchema], [UserId], [Delimiter], [SplitSelector], [SplitIndex], [AddedAt], [UpdatedAt])
        SELECT   [ID],
                 [Code],
                 [Name],
                 [Description],
...
IF EXISTS (SELECT TOP 1 1 
           FROM   [dbo].[DataSource])
    BEGIN
        INSERT INTO [dbo].[tmp_ms_xx_DataSource] ([ID], [Code], [Name], [Description], [Url], [DefaultNullValue], [ErrorEstimate], [UpdateFreq], [StartDate], [EndDate], [LastUpdate], [DataSchemaID], [UserId], [AddedAt], [UpdatedAt])
        SELECT   [ID],
                 [Code],
                 [Name],
                 [Description],
...
CREATE TABLE [dbo].[tmp_ms_xx_DataSourceRole] (
    ...
    CONSTRAINT [tmp_ms_xx_constraint_PK_DataSourceRole1] PRIMARY KEY CLUSTERED ([ID] ASC),
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        INSERT INTO [dbo].[tmp_ms_xx_DataSourceRole] ([ID], [DataSourceID], [RoleId], [DateStart], [DateEnd], [RoleName], [IsRoleReadOnly], [UserId], [AddedAt], [UpdatedAt])
        SELECT   [ID],
                 [DataSourceID],
                 [RoleId],
                 [DateStart],
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        INSERT INTO [dbo].[tmp_ms_xx_DataSourceTransformation] ([ID], [TransformationTypeID], [PhenomenonID], [PhenomenonOfferingID], [PhenomenonUOMID], [StartDate], [EndDate], [DataSourceID], [Definition], [NewPhenomenonOfferingID], [NewPhenomenonUOMID], [Rank], [SensorID], [UserId], [AddedAt], [UpdatedAt])
        SELECT   [ID],
...
CREATE TABLE [dbo].[tmp_ms_xx_DataSourceType] (
    ...
    CONSTRAINT [tmp_ms_xx_constraint_PK_DataSourceType1] PRIMARY KEY CLUSTERED ([ID] ASC),
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        INSERT INTO [dbo].[tmp_ms_xx_DataSourceType] ([ID], [Code], [Description], [UserId], [AddedAt], [UpdatedAt])
        SELECT   [ID],
                 [Code],
                 [Description],
                 [UserId],
...
CREATE TABLE [dbo].[tmp_ms_xx_Instrument_DataSource] (
    ...
    CONSTRAINT [tmp_ms_xx_constraint_PK_Instrument_DataSource1] PRIMARY KEY CLUSTERED ([ID] ASC),
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        INSERT INTO [dbo].[tmp_ms_xx_Instrument_DataSource] ([ID], [InstrumentID], [DataSourceID], [StartDate], [EndDate], [UserId], [AddedAt], [UpdatedAt])
        SELECT   [ID],
                 [InstrumentID],
                 [DataSourceID],
                 [StartDate],
...
CREATE TABLE [dbo].[tmp_ms_xx_Offering] (
    ...
    CONSTRAINT [tmp_ms_xx_constraint_PK_Offering1] PRIMARY KEY CLUSTERED ([ID] ASC),
...
IF EXISTS (SELECT TOP 1 1 
           FROM   [dbo].[Offering])
    BEGIN
        INSERT INTO [dbo].[tmp_ms_xx_Offering] ([ID], [Code], [Name], [Description], [UserId], [AddedAt], [UpdatedAt])
        SELECT   [ID],
                 [Code],
                 [Name],
                 [Description],
...
CREATE TABLE [dbo].[tmp_ms_xx_Organisation_Site] (
    ...
    CONSTRAINT [tmp_ms_xx_constraint_PK_Organisation_Site1] PRIMARY KEY CLUSTERED ([ID] ASC),
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        INSERT INTO [dbo].[tmp_ms_xx_Organisation_Site] ([ID], [OrganisationID], [SiteID], [OrganisationRoleID], [StartDate], [EndDate], [UserId], [AddedAt], [UpdatedAt])
        SELECT   [ID],
                 [OrganisationID],
                 [SiteID],
                 [OrganisationRoleID],
...
CREATE TABLE [dbo].[tmp_ms_xx_Organisation_Station] (
    ...
    CONSTRAINT [tmp_ms_xx_constraint_PK_Organisation_Station1] PRIMARY KEY CLUSTERED ([ID] ASC),
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        INSERT INTO [dbo].[tmp_ms_xx_Organisation_Station] ([ID], [OrganisationID], [StationID], [OrganisationRoleID], [StartDate], [EndDate], [UserId], [AddedAt], [UpdatedAt])
        SELECT   [ID],
                 [OrganisationID],
                 [StationID],
                 [OrganisationRoleID],
...
CREATE TABLE [dbo].[tmp_ms_xx_OrganisationRole] (
    ...
    CONSTRAINT [tmp_ms_xx_constraint_PK_OrganisationRole1] PRIMARY KEY CLUSTERED ([ID] ASC),
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        INSERT INTO [dbo].[tmp_ms_xx_OrganisationRole] ([ID], [Code], [Name], [Description], [UserId], [AddedAt], [UpdatedAt])
        SELECT   [ID],
                 [Code],
                 [Name],
                 [Description],
...
CREATE TABLE [dbo].[tmp_ms_xx_Phenomenon] (
    ...
    CONSTRAINT [tmp_ms_xx_constraint_PK_Phenomenon1] PRIMARY KEY CLUSTERED ([ID] ASC),
...
IF EXISTS (SELECT TOP 1 1 
           FROM   [dbo].[Phenomenon])
    BEGIN
        INSERT INTO [dbo].[tmp_ms_xx_Phenomenon] ([ID], [Code], [Name], [Description], [Url], [UserId], [AddedAt], [UpdatedAt])
        SELECT   [ID],
                 [Code],
                 [Name],
                 [Description],
...
CREATE TABLE [dbo].[tmp_ms_xx_PhenomenonOffering] (
    ...
    CONSTRAINT [tmp_ms_xx_constraint_PK_PhenomenonOffering1] PRIMARY KEY CLUSTERED ([ID] ASC),
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        INSERT INTO [dbo].[tmp_ms_xx_PhenomenonOffering] ([ID], [PhenomenonID], [OfferingID], [UserId], [AddedAt], [UpdatedAt])
        SELECT   [ID],
                 [PhenomenonID],
                 [OfferingID],
                 [UserId],
...
CREATE TABLE [dbo].[tmp_ms_xx_PhenomenonUOM] (
    ...
    CONSTRAINT [tmp_ms_xx_constraint_PK_PhenomenonUOM1] PRIMARY KEY CLUSTERED ([ID] ASC),
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        INSERT INTO [dbo].[tmp_ms_xx_PhenomenonUOM] ([ID], [PhenomenonID], [UnitOfMeasureID], [IsDefault], [UserId], [AddedAt], [UpdatedAt])
        SELECT   [ID],
                 [PhenomenonID],
                 [UnitOfMeasureID],
                 [IsDefault],
...
CREATE TABLE [dbo].[tmp_ms_xx_Programme] (
    ...
    CONSTRAINT [tmp_ms_xx_constraint_PK_Programme1] PRIMARY KEY CLUSTERED ([ID] ASC),
...
IF EXISTS (SELECT TOP 1 1 
           FROM   [dbo].[Programme])
    BEGIN
        INSERT INTO [dbo].[tmp_ms_xx_Programme] ([ID], [Code], [Name], [Description], [Url], [StartDate], [EndDate], [UserId], [AddedAt], [UpdatedAt])
        SELECT   [ID],
                 [Code],
                 [Name],
                 [Description],
...
IF EXISTS (SELECT TOP 1 1 
           FROM   [dbo].[Project])
    BEGIN
        INSERT INTO [dbo].[tmp_ms_xx_Project] ([ID], [ProgrammeID], [Code], [Name], [Description], [Url], [StartDate], [EndDate], [UserId], [AddedAt], [UpdatedAt])
        SELECT   [ID],
                 [ProgrammeID],
                 [Code],
                 [Name],
...
CREATE TABLE [dbo].[tmp_ms_xx_Project_Station] (
    ...
    CONSTRAINT [tmp_ms_xx_constraint_PK_Project_Station1] PRIMARY KEY CLUSTERED ([ID] ASC),
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        INSERT INTO [dbo].[tmp_ms_xx_Project_Station] ([ID], [ProjectID], [StationID], [StartDate], [EndDate], [UserId], [AddedAt], [UpdatedAt])
        SELECT   [ID],
                 [ProjectID],
                 [StationID],
                 [StartDate],
...
CREATE TABLE [dbo].[tmp_ms_xx_SchemaColumn] (
    ...
    CONSTRAINT [tmp_ms_xx_constraint_PK_SchemaColumn1] PRIMARY KEY CLUSTERED ([ID] ASC),
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        INSERT INTO [dbo].[tmp_ms_xx_SchemaColumn] ([ID], [DataSchemaID], [Number], [Name], [SchemaColumnTypeID], [Width], [Format], [PhenomenonID], [PhenomenonOfferingID], [PhenomenonUOMID], [EmptyValue], [FixedTime], [UserId], [AddedAt], [UpdatedAt])
        SELECT   [ID],
                 [DataSchemaID],
                 [Number],
                 [Name],
...
CREATE TABLE [dbo].[tmp_ms_xx_SchemaColumnType] (
    ...
    CONSTRAINT [tmp_ms_xx_constraint_PK_SchemaColumnType1] PRIMARY KEY CLUSTERED ([ID] ASC),
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        INSERT INTO [dbo].[tmp_ms_xx_SchemaColumnType] ([ID], [Name], [Description], [UserId], [AddedAt], [UpdatedAt])
        SELECT   [ID],
                 [Name],
                 [Description],
                 [UserId],
...
CREATE TABLE [dbo].[tmp_ms_xx_Site] (
    ...
    CONSTRAINT [tmp_ms_xx_constraint_PK_Site1] PRIMARY KEY CLUSTERED ([ID] ASC),
...
IF EXISTS (SELECT TOP 1 1 
           FROM   [dbo].[Site])
    BEGIN
        INSERT INTO [dbo].[tmp_ms_xx_Site] ([ID], [Code], [Name], [Description], [Url], [StartDate], [EndDate], [UserId], [AddedAt], [UpdatedAt])
        SELECT   [ID],
                 [Code],
                 [Name],
                 [Description],
...
CREATE TABLE [dbo].[tmp_ms_xx_Station] (
    ...
    CONSTRAINT [tmp_ms_xx_constraint_PKStation1] PRIMARY KEY CLUSTERED ([ID] ASC),
...
IF EXISTS (SELECT TOP 1 1 
           FROM   [dbo].[Station])
    BEGIN
        INSERT INTO [dbo].[tmp_ms_xx_Station] ([ID], [Code], [Name], [Description], [Url], [Latitude], [Longitude], [Elevation], [ProjectSiteID], [UserId], [SiteID], [StartDate], [EndDate], [AddedAt], [UpdatedAt])
        SELECT   [ID],
                 [Code],
                 [Name],
                 [Description],
...
CREATE TABLE [dbo].[tmp_ms_xx_Status] (
    ...
    CONSTRAINT [tmp_ms_xx_constraint_PK_Status1] PRIMARY KEY CLUSTERED ([ID] ASC),
...
IF EXISTS (SELECT TOP 1 1 
           FROM   [dbo].[Status])
    BEGIN
        INSERT INTO [dbo].[tmp_ms_xx_Status] ([ID], [Code], [Name], [Description], [UserId], [AddedAt], [UpdatedAt])
        SELECT   [ID],
                 [Code],
                 [Name],
                 [Description],
...
CREATE TABLE [dbo].[tmp_ms_xx_StatusReason] (
    ...
    CONSTRAINT [tmp_ms_xx_constraint_PK_StatusReason1] PRIMARY KEY CLUSTERED ([ID] ASC),
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        INSERT INTO [dbo].[tmp_ms_xx_StatusReason] ([ID], [Code], [Name], [Description], [UserId], [AddedAt], [UpdatedAt])
        SELECT   [ID],
                 [Code],
                 [Name],
                 [Description],
...
CREATE TABLE [dbo].[tmp_ms_xx_TransformationType] (
    ...
    CONSTRAINT [tmp_ms_xx_constraint_PK_TransformationType1] PRIMARY KEY CLUSTERED ([ID] ASC),
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        INSERT INTO [dbo].[tmp_ms_xx_TransformationType] ([ID], [Code], [Name], [Description], [iorder], [UserId], [AddedAt], [UpdatedAt])
        SELECT   [ID],
                 [Code],
                 [Name],
                 [Description],
...
CREATE TABLE [dbo].[tmp_ms_xx_UnitOfMeasure] (
    ...
    CONSTRAINT [tmp_ms_xx_constraint_PK_UnitOfMeasure1] PRIMARY KEY CLUSTERED ([ID] ASC),
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        INSERT INTO [dbo].[tmp_ms_xx_UnitOfMeasure] ([ID], [Code], [Unit], [UnitSymbol], [UserId], [AddedAt], [UpdatedAt])
        SELECT   [ID],
                 [Code],
                 [Unit],
                 [UnitSymbol],
...
GO
PRINT N'Creating [dbo].[UserDownloads]...';
...
CREATE TABLE [dbo].[UserDownloads] (
    ...
    CONSTRAINT [PK_UserDownloads] PRIMARY KEY CLUSTERED ([ID] ASC),
    CONSTRAINT [UX_UserDownloads_UserId_Name] UNIQUE NONCLUSTERED ([UserId] ASC, [Name] ASC)
);
...
GO
PRINT N'Creating [dbo].[UserQueries]...';
...
CREATE TABLE [dbo].[UserQueries] (
    ...
    CONSTRAINT [UX_UserQueries_UserId_Name] UNIQUE NONCLUSTERED ([UserId] ASC, [Name] ASC)
);
...
GO
PRINT N'Creating [dbo].[DF_UserDownloads_ID]...';


GO
ALTER TABLE [dbo].[UserDownloads]
    ADD CONSTRAINT [DF_UserDownloads_ID] DEFAULT NewId() FOR [ID];


GO
PRINT N'Creating [dbo].[DF_UserDownloads_AddedAt]...';


GO
ALTER TABLE [dbo].[UserDownloads]
    ADD CONSTRAINT [DF_UserDownloads_AddedAt] DEFAULT GetDate() FOR [AddedAt];


GO
PRINT N'Creating [dbo].[DF_UserDownloads_UpdatedAt]...';


GO
ALTER TABLE [dbo].[UserDownloads]
    ADD CONSTRAINT [DF_UserDownloads_UpdatedAt] DEFAULT GetDate() FOR [UpdatedAt];


GO
PRINT N'Creating [dbo].[DF_UserQueries_ID]...';


GO
ALTER TABLE [dbo].[UserQueries]
    ADD CONSTRAINT [DF_UserQueries_ID] DEFAULT NewId() FOR [ID];


GO
PRINT N'Creating [dbo].[DF_UserQueries_AddedAt]...';


GO
ALTER TABLE [dbo].[UserQueries]
    ADD CONSTRAINT [DF_UserQueries_AddedAt] DEFAULT GetDate() FOR [AddedAt];


GO
PRINT N'Creating [dbo].[DF_UserQueries_UpdatedAt]...';


GO
ALTER TABLE [dbo].[UserQueries]
    ADD CONSTRAINT [DF_UserQueries_UpdatedAt] DEFAULT GetDate() FOR [UpdatedAt];
...
GO
PRINT N'Creating [dbo].[FK_UserDownloads_AspNetUsers_UserId]...';


GO
ALTER TABLE [dbo].[UserDownloads] WITH NOCHECK
    ADD CONSTRAINT [FK_UserDownloads_AspNetUsers_UserId] FOREIGN KEY ([UserId]) REFERENCES [dbo].[AspNetUsers] ([Id]);


GO
PRINT N'Creating [dbo].[FK_UserDownloads_AspNetUsers_AddedBy]...';


GO
ALTER TABLE [dbo].[UserDownloads] WITH NOCHECK
    ADD CONSTRAINT [FK_UserDownloads_AspNetUsers_AddedBy] FOREIGN KEY ([UserId]) REFERENCES [dbo].[AspNetUsers] ([Id]);


GO
PRINT N'Creating [dbo].[FK_UserDownloads_AspNetUsers_UpdatedBy]...';


GO
ALTER TABLE [dbo].[UserDownloads] WITH NOCHECK
    ADD CONSTRAINT [FK_UserDownloads_AspNetUsers_UpdatedBy] FOREIGN KEY ([UserId]) REFERENCES [dbo].[AspNetUsers] ([Id]);


GO
PRINT N'Creating [dbo].[FK_UserQueries_AspNetUsers_UserId]...';


GO
ALTER TABLE [dbo].[UserQueries] WITH NOCHECK
    ADD CONSTRAINT [FK_UserQueries_AspNetUsers_UserId] FOREIGN KEY ([UserId]) REFERENCES [dbo].[AspNetUsers] ([Id]);


GO
PRINT N'Creating [dbo].[FK_UserQueries_AspNetUsers_AddedBy]...';


GO
ALTER TABLE [dbo].[UserQueries] WITH NOCHECK
    ADD CONSTRAINT [FK_UserQueries_AspNetUsers_AddedBy] FOREIGN KEY ([UserId]) REFERENCES [dbo].[AspNetUsers] ([Id]);


GO
PRINT N'Creating [dbo].[FK_UserQueries_AspNetUsers_UpdatedBy]...';


GO
ALTER TABLE [dbo].[UserQueries] WITH NOCHECK
    ADD CONSTRAINT [FK_UserQueries_AspNetUsers_UpdatedBy] FOREIGN KEY ([UserId]) REFERENCES [dbo].[AspNetUsers] ([Id]);
...
GO
PRINT N'Creating [dbo].[TR_UserQueries_Insert]...';
...
GO
PRINT N'Creating [dbo].[TR_UserQueries_Update]...';
...
GO
PRINT N'Creating [dbo].[vDownloads]...';
...
ALTER TABLE [dbo].[UserDownloads] WITH CHECK CHECK CONSTRAINT [FK_UserDownloads_AspNetUsers_UserId];

ALTER TABLE [dbo].[UserDownloads] WITH CHECK CHECK CONSTRAINT [FK_UserDownloads_AspNetUsers_AddedBy];

ALTER TABLE [dbo].[UserDownloads] WITH CHECK CHECK CONSTRAINT [FK_UserDownloads_AspNetUsers_UpdatedBy];

ALTER TABLE [dbo].[UserQueries] WITH CHECK CHECK CONSTRAINT [FK_UserQueries_AspNetUsers_UserId];

ALTER TABLE [dbo].[UserQueries] WITH CHECK CHECK CONSTRAINT [FK_UserQueries_AspNetUsers_AddedBy];

ALTER TABLE [dbo].[UserQueries] WITH CHECK CHECK CONSTRAINT [FK_UserQueries_AspNetUsers_UpdatedBy];
