...
GO
PRINT N'Creating [dbo].[ObservationsSequence]...';
...
CREATE TABLE [dbo].[tmp_ms_xx_Observation] (
    [ID]                   INT                  CONSTRAINT [DF_Observation_ID] DEFAULT ( NEXT VALUE FOR dbo.ObservationsSequence) NOT NULL,
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        INSERT INTO [dbo].[tmp_ms_xx_Observation] ([SensorID], [ValueDate], [RawValue], [DataValue], [Comment], [PhenomenonOfferingID], [PhenomenonUOMID], [ImportBatchID], [StatusID], [StatusReasonID], [CorrelationID], [UserId], [AddedDate], [AddedAt], [UpdatedAt])
        SELECT [SensorID],
               [ValueDate],
               [RawValue],
               [DataValue],
