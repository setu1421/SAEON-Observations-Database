...
GO
PRINT N'Dropping Index [dbo].[Observation].[IX_Observations_SensorID_ValueDate]...';


GO
DROP INDEX [IX_Observations_SensorID_ValueDate]
    ON [dbo].[Observation];


GO
PRINT N'Altering Table [dbo].[Datasets]...';
...
ALTER TABLE [dbo].[Datasets]
    ADD [CSVFileName]    VARCHAR (500) NULL,
...
GO
PRINT N'Creating Index [dbo].[Observation].[IX_Observation_SensorID_ValueDate]...';
...
GO
PRINT N'Refreshing View [dbo].[vDatasetsExpansion]...';
...
GO
EXECUTE sp_refreshsqlmodule N'[dbo].[vDatasetsExpansion]';
