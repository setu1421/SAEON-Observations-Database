...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        INSERT INTO [dbo].[tmp_ms_xx_UserDownloads] ([ID], [UserId], [Name], [Description], [AddedAt], [AddedBy], [UpdatedAt], [UpdatedBy], [MetadataURL], [DownloadURL], [Citation], [Date], [Title], [Keywords], [Input], [RequeryURL], [DigitalObjectIdentifierID], [MetadataJson], [ZipFullName], [ZipCheckSum], [Places], [LatitudeNorth], [LatitudeSouth], [LongitudeWest], [LongitudeEast], [ElevationMinimum], [ElevationMaximum], [StartDate], [EndDate], [OpenDataPlatformID], [ZipURL])
        SELECT   [ID],
                 [UserId],
                 [Name],
                 [Description],
