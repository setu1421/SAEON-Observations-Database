...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        INSERT INTO [dbo].[tmp_ms_xx_UserDownloads] ([ID], [UserId], [Name], [Description], [MetadataURL], [DownloadURL], [Citation], [AddedAt], [AddedBy], [UpdatedAt], [UpdatedBy], [Date], [Title], [Keywords], [Input], [RequeryURL], [DigitalObjectIdentifierID], [MetadataJson], [ZipFullName], [ZipCheckSum], [Places], [LatitudeNorth], [LatitudeSouth], [LongitudeWest], [LongitudeEast], [ElevationMinimum], [ElevationMaximum], [StartDate], [EndDate], [OpenDataPlatformID], [ZipURL])
        SELECT   [ID],
                 [UserId],
                 [Name],
                 [Description],
