...
GO
PRINT N'Dropping [dbo].[progress_Progress_Resolved]...';


GO
DROP VIEW [dbo].[progress_Progress_Resolved];


GO
PRINT N'Dropping [dbo].[vApiDataGaps]...';


GO
DROP VIEW [dbo].[vApiDataGaps];
...
GO
PRINT N'Dropping [dbo].[vInventory]...';
...
GO
DROP VIEW [dbo].[vInventoryPhenomenaOfferings];
...
GO
DROP VIEW [dbo].[vInventoryStations];
...
GO
PRINT N'Dropping [dbo].[vSensorThingsDatastreams]...';
...
GO
DROP VIEW [dbo].[vSensorThingsDatastreams];
...
GO
DROP VIEW [dbo].[vApiDataDownload];
...
GO
DROP VIEW [dbo].[vApiSpacialCoverage];
...
GO
DROP VIEW [dbo].[vApiTemporalCoverage];
...
GO
DROP VIEW [dbo].[vInventoryInstruments];
...
GO
DROP VIEW [dbo].[vInventoryOrganisations];
...
GO
DROP VIEW [dbo].[vInventoryTotals];
...
GO
PRINT N'Dropping [dbo].[vObservation]...';


GO
DROP VIEW [dbo].[vObservation];
...
GO
DROP VIEW [dbo].[vObservationsList];
...
GO
PRINT N'Dropping [dbo].[vObservationExpansion]...';
...
GO
DROP VIEW [dbo].[vObservationExpansion];
