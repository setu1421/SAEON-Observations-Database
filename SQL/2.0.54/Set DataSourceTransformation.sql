...
set
  PhenomenonOfferingID = do.NewPhenomenonOfferingID,
  NewPhenomenonOfferingID = ndo.NewPhenomenonOfferingID
from
  DataSourceTransformation
  inner join DepthOfferings do
    on (DataSourceTransformation.PhenomenonOfferingID = do.OldPhenomenonOfferingID)
  left join DepthOfferings ndo
    on (DataSourceTransformation.NewPhenomenonOfferingID = ndo.OldPhenomenonOfferingID)
