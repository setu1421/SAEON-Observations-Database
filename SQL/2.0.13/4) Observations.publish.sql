...
GO
ALTER TABLE [dbo].[aspnet_Users] DROP CONSTRAINT [FK__aspnet_Us__Appli__239E4DCF];
...
GO
ALTER TABLE [dbo].[aspnet_Membership] DROP CONSTRAINT [FK__aspnet_Me__Appli__37A5467C];
...
GO
ALTER TABLE [dbo].[aspnet_Paths] DROP CONSTRAINT [FK__aspnet_Pa__Appli__70DDC3D8];
...
GO
ALTER TABLE [dbo].[aspnet_PersonalizationPerUser] DROP CONSTRAINT [FK__aspnet_Pe__PathI__7E37BEF6];
...
GO
ALTER TABLE [dbo].[aspnet_Profile] DROP CONSTRAINT [FK__aspnet_Pr__UserI__4E88ABD4];
...
GO
ALTER TABLE [dbo].[aspnet_UsersInRoles] DROP CONSTRAINT [FK__aspnet_Us__RoleI__60A75C0F];
...
GO
ALTER TABLE [dbo].[aspnet_Membership] DROP CONSTRAINT [FK__aspnet_Me__UserI__38996AB5];
...
GO
ALTER TABLE [dbo].[aspnet_UsersInRoles] DROP CONSTRAINT [FK__aspnet_Us__UserI__5FB337D6];
...
GO
ALTER TABLE [dbo].[aspnet_PersonalizationPerUser] DROP CONSTRAINT [FK__aspnet_Pe__UserI__7F2BE32F];
...
GO
ALTER TABLE [dbo].[aspnet_Applications] DROP CONSTRAINT [UQ__aspnet_A__17477DE41A14E395];
...
GO
ALTER TABLE [dbo].[aspnet_Applications] DROP CONSTRAINT [UQ__aspnet_A__309103311CF15040];
...
GO
ALTER TABLE [dbo].[aspnet_Applications] DROP CONSTRAINT [PK__aspnet_A__C93A4C98173876EA];
...
GO
ALTER TABLE [dbo].[aspnet_Membership] DROP CONSTRAINT [PK__aspnet_M__1788CC4D35BCFE0A];
...
GO
ALTER TABLE [dbo].[aspnet_Paths] DROP CONSTRAINT [PK__aspnet_P__CD67DC586EF57B66];
...
GO
ALTER TABLE [dbo].[aspnet_PersonalizationPerUser] DROP CONSTRAINT [PK__aspnet_P__3214EC067B5B524B];
...
GO
ALTER TABLE [dbo].[aspnet_Roles] DROP CONSTRAINT [PK__aspnet_R__8AFACE1B5812160E];
...
GO
ALTER TABLE [dbo].[aspnet_Users] DROP CONSTRAINT [PK__aspnet_U__1788CC4D21B6055D];
...
GO
PRINT N'Creating [dbo].[vDataSourceRole]...';
...
DECLARE tableconstraintnames CURSOR LOCAL FORWARD_ONLY
    FOR SELECT SCHEMA_NAME([schema_id]),
               ...
               0
        FROM   [sys].[objects]
        WHERE  [parent_object_id] IN (OBJECT_ID(N'dbo.aspnet_Users'), OBJECT_ID(N'dbo.aspnet_Membership'), OBJECT_ID(N'dbo.aspnet_Roles'), OBJECT_ID(N'dbo.aspnet_Paths'), OBJECT_ID(N'dbo.aspnet_PersonalizationAllUsers'), OBJECT_ID(N'dbo.aspnet_PersonalizationPerUser'), OBJECT_ID(N'dbo.aspnet_Profile'), OBJECT_ID(N'dbo.aspnet_UsersInRoles'))
               AND [type] IN (N'F', N'C')
