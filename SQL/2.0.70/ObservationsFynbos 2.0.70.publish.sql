...
GO
Drop View If Exists vHomeDashboard;
...
GO
PRINT N'Creating Table [dbo].[InventorySnapshots]...';
...
CREATE TABLE [dbo].[InventorySnapshots] (
    ...
    CONSTRAINT [PK_InventorySnapshots] PRIMARY KEY CLUSTERED ([ID] ASC),
    CONSTRAINT [UX_InventorySnapshots_ID_When] UNIQUE NONCLUSTERED ([ID] ASC, [When] ASC)
);
...
GO
PRINT N'Creating Default Constraint [dbo].[DF_InventorySnapshots_ID]...';


GO
ALTER TABLE [dbo].[InventorySnapshots]
    ADD CONSTRAINT [DF_InventorySnapshots_ID] DEFAULT newid() FOR [ID];


GO
PRINT N'Creating Default Constraint [dbo].[DF_InventorySnapshots_When]...';


GO
ALTER TABLE [dbo].[InventorySnapshots]
    ADD CONSTRAINT [DF_InventorySnapshots_When] DEFAULT getdate() FOR [When];
...
GO
PRINT N'Creating Procedure [dbo].[spCreateImportBatchSummaries]...';
...
GO
PRINT N'Creating Procedure [dbo].[spCreateInventorySnapshot]...';
