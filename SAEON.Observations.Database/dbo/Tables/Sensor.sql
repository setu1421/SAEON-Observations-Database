...
--> Added 2.0.4 20160508 TimPN
    CONSTRAINT [FK_Sensor_Instrument] FOREIGN KEY ([InstrumentID]) REFERENCES [dbo].[Instrument] ([ID]),
--< Added 2.0.4 20160508 TimPN
...
--> Removed 2.0.4 20160506 TimPN, readd once duplicate names fixed
...
--> Added 2.0.4 20160508 TimPN
GO
CREATE INDEX [IX_Sensor_InstrumentID] ON [dbo].[Sensor] ([InstrumentID])
--< Added 2.0.4 20160508 TimPN
