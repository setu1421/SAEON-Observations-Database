...
namespace SubSonic.Utilities
{
    ...
    public class Utility
    {
        ...
        {
            return provider.DatabaseVersion.Contains("SQL Server 2008") || provider.DatabaseVersion.Contains("SQL Server 2012") ||
                provider.DatabaseVersion.Contains("SQL Server 2014") || provider.DatabaseVersion.Contains("SQL Server 2016");
        }
