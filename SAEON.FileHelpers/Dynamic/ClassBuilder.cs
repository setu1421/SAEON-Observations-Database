...
namespace FileHelpers.Dynamic
{
    ...
    // TimPN
    public abstract partial class ClassBuilder
    {
        //---------------------
        //->  STATIC METHODS
        ...
        private void AddAttributesInternal(AttributesBuilder attbs)
        {
            ...
            // TimPN
            if (!String.IsNullOrEmpty(mSplitSelector))
                attbs.AddAttribute(String.Concat("DataSplitAttribute(\"", mSplitSelector, "\", ", mSplitIndex, ")"));
            // TimPN
        }
        ...
        public static ClassBuilder LoadFromXml(XmlDocument document)
        {
            ...
            // TimPN
            node = document.DocumentElement["SplitSelector"];
            if (node != null) res.SplitSelector = node.InnerText;

            node = document.DocumentElement["SplitIndex"];
            if (node != null) res.SplitIndex = int.Parse(node.InnerText);
        ...
        public void SaveToXml(TextWriter writer)
        {
            ...
            // TimPN
            if (!String.IsNullOrEmpty(this.SplitSelector))
            {
                xml.WriteElement("SplitSelector", this.SplitSelector.ToString());
                xml.WriteElement("SplitIndex", this.SplitIndex.ToString());
            }
            // TimPN
