                    ...
                    <ext:Panel ID="pnlSouth" runat="server" Title="Sites" Layout="FitLayout"
                            ...
                            <ext:Toolbar ID="Toolbar2" runat="server">
                                <Items>
                                    <ext:Button ID="btnLinkSite" runat="server" Icon="LinkAdd" Text="Link Sites">
                                        ...
                                        <Listeners>
                                            <Click Handler="if(Ext.getCmp('#{ProjectsGrid}') && #{ProjectsGrid}.getSelectionModel().hasSelection()){#{AvailableSitesStore}.reload();#{AvailableSitesWindow}.show()}else{Ext.Msg.alert('Invalid Selection','Select a site.')}" />
                                        </Listeners>
                                    </ext:Button>
                                </Items>
                            </ext:Toolbar>
                        ...
                        <Items>
                            <ext:GridPanel ID="SitesGrid" runat="server" Border="false" ClientIDMode="Static">
                                <Store>
                                    <ext:Store ID="SitesGridStore" runat="server" OnRefreshData="SitesGridStore_RefreshData">
                                        <Proxy>
                                            <ext:PageProxy />
                                        </Proxy>
                                        <Reader>
...
<%--    <ext:Window ID="OrganisationLinkWindow" runat="server" Width="450" Height="300" Closable="true"
    ...
    <ext:Window ID="AvailableSitesWindow" runat="server" Collapsible="false" Maximizable="false"
        Title="Available Sites" Width="620" Height="300" X="50" Y="50" Layout="FitLayout" Hidden="true" ClientIDMode="Static">
        <Listeners>
            <Hide Fn="CloseAvailableSites" />
        </Listeners>
        <Items>
            <ext:GridPanel ID="AvailableSitesGrid" runat="server" Header="false" Border="false"
                ClientIDMode="Static">
                <Store>
                    <ext:Store ID="AvailableSitesStore" runat="server" OnRefreshData="AvailableSitesStore_RefreshData">
                        <Proxy>
                            <ext:PageProxy />
                        </Proxy>
                        <Reader>
                ...
                <Buttons>
                    <ext:Button ID="LinkSites" runat="server" Text="Save" Icon="Accept">
                        <DirectEvents>
                            <Click OnEvent="LinkSites_Click">
                                <EventMask ShowMask="true" />
                            </Click>
                        </DirectEvents>
                    </ext:Button>
