...
namespace SAEON.Observations.Data
{
    ...
    public partial class InstrumentDataSourceController
    {
	    ...
	    public void Insert(Guid Id,Guid InstrumentID,Guid DataSourceID,DateTime? StartDate,DateTime? EndDate,Guid UserId,DateTime? AddedAt,DateTime? UpdatedAt,byte[] RowVersion)
	    {
	    ...
	    public void Update(Guid Id,Guid InstrumentID,Guid DataSourceID,DateTime? StartDate,DateTime? EndDate,Guid UserId,DateTime? AddedAt,DateTime? UpdatedAt,byte[] RowVersion)
	    {
		    InstrumentDataSource item = new InstrumentDataSource();
	        item.MarkOld();
	        item.IsLoaded = true;
