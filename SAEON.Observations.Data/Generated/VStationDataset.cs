...
namespace SAEON.Observations.Data{
    /// <summary>
    /// Strongly-typed collection for the VStationDataset class.
    /// </summary>
    [Serializable]
    public partial class VStationDatasetCollection : ReadOnlyList<VStationDataset, VStationDatasetCollection>
    {        
        public VStationDatasetCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the vStationDatasets view.
    /// </summary>
    [Serializable]
    public partial class VStationDataset : ReadOnlyRecord<VStationDataset>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("vStationDatasets", TableType.View, DataService.GetInstance("ObservationsDB"));
                ...
                DataService.Providers["ObservationsDB"].AddSchema("vStationDatasets",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public VStationDataset()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public VStationDataset(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public VStationDataset(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public VStationDataset(string columnName, object columnValue)
        {
            SetSQLProps();
