...
namespace SAEON.Observations.Data{
    /// <summary>
    /// Strongly-typed collection for the VDataSourceRoleOld class.
    /// </summary>
    [Serializable]
    public partial class VDataSourceRoleOldCollection : ReadOnlyList<VDataSourceRoleOld, VDataSourceRoleOldCollection>
    {        
        public VDataSourceRoleOldCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the vDataSourceRoleOld view.
    /// </summary>
    [Serializable]
    public partial class VDataSourceRoleOld : ReadOnlyRecord<VDataSourceRoleOld>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("vDataSourceRoleOld", TableType.View, DataService.GetInstance("ObservationsDB"));
                ...
                DataService.Providers["ObservationsDB"].AddSchema("vDataSourceRoleOld",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public VDataSourceRoleOld()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public VDataSourceRoleOld(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public VDataSourceRoleOld(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public VDataSourceRoleOld(string columnName, object columnValue)
        {
            SetSQLProps();
