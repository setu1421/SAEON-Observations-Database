...
namespace SAEON.Observations.Data
{
    ...
    public partial class AspnetUser : ActiveRecord<AspnetUser>, IActiveRecord
    {
        ...
        {
            return new SAEON.Observations.Data.InstrumentOrganisationCollection().Where(InstrumentOrganisation.Columns.UserId, UserId).Load();
        }
        ...
        {
            return new SAEON.Observations.Data.ProgrammeProjectCollection().Where(ProgrammeProject.Columns.UserId, UserId).Load();
        }
        ...
        {
            return new SAEON.Observations.Data.SiteOrganisationCollection().Where(SiteOrganisation.Columns.UserId, UserId).Load();
        }
        public SAEON.Observations.Data.SiteProjectCollection SiteProjectRecords()
        {
            return new SAEON.Observations.Data.SiteProjectCollection().Where(SiteProject.Columns.UserId, UserId).Load();
        }
        public SAEON.Observations.Data.SiteStationCollection SiteStationRecords()
        {
            return new SAEON.Observations.Data.SiteStationCollection().Where(SiteStation.Columns.UserId, UserId).Load();
        }
        ...
        {
            return new SAEON.Observations.Data.StationOrganisationCollection().Where(StationOrganisation.Columns.UserId, UserId).Load();
        }
        public SAEON.Observations.Data.StationProjectCollection StationProjectRecords()
        {
            return new SAEON.Observations.Data.StationProjectCollection().Where(StationProject.Columns.UserId, UserId).Load();
        }
