...
namespace SAEON.Observations.Data{
    /// <summary>
    /// Strongly-typed collection for the VInventoryDataset class.
    /// </summary>
    [Serializable]
    public partial class VInventoryDatasetCollection : ReadOnlyList<VInventoryDataset, VInventoryDatasetCollection>
    {        
        public VInventoryDatasetCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the vInventoryDatasets view.
    /// </summary>
    [Serializable]
    public partial class VInventoryDataset : ReadOnlyRecord<VInventoryDataset>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("vInventoryDatasets", TableType.View, DataService.GetInstance("ObservationsDB"));
                ...
                DataService.Providers["ObservationsDB"].AddSchema("vInventoryDatasets",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public VInventoryDataset()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public VInventoryDataset(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public VInventoryDataset(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public VInventoryDataset(string columnName, object columnValue)
        {
            SetSQLProps();
