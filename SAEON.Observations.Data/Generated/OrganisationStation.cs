...
namespace SAEON.Observations.Data
{
	...
	public partial class OrganisationStation : ActiveRecord<OrganisationStation>, IActiveRecord
	{
		...
		/// </summary>
		public static void Insert(Guid varId,Guid varOrganisationID,Guid varStationID,Guid varOrganisationRoleID,string varStartDate,string varEndDate,Guid varUserId,DateTime? varAddedAt,DateTime? varUpdatedAt)
		{
		...
		/// </summary>
		public static void Update(Guid varId,Guid varOrganisationID,Guid varStationID,Guid varOrganisationRoleID,string varStartDate,string varEndDate,Guid varUserId,DateTime? varAddedAt,DateTime? varUpdatedAt)
		{
			OrganisationStation item = new OrganisationStation();
