...
namespace SAEON.Observations.Data
{
	...
	public partial class InstrumentDataSource : ActiveRecord<InstrumentDataSource>, IActiveRecord
	{
		...
		/// </summary>
		public static void Insert(Guid varId,Guid varInstrumentID,Guid varDataSourceID,DateTime? varStartDate,DateTime? varEndDate,Guid varUserId,DateTime? varAddedAt,DateTime? varUpdatedAt,byte[] varRowVersion)
		{
		...
		/// </summary>
		public static void Update(Guid varId,Guid varInstrumentID,Guid varDataSourceID,DateTime? varStartDate,DateTime? varEndDate,Guid varUserId,DateTime? varAddedAt,DateTime? varUpdatedAt,byte[] varRowVersion)
		{
			InstrumentDataSource item = new InstrumentDataSource();
