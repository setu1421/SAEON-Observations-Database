...
namespace SAEON.Observations.Data
{
    ...
    public partial class StationInstrumentController
    {
	    ...
	    public void Insert(Guid Id,Guid StationID,Guid InstrumentID,string StartDate,string EndDate,Guid UserId,DateTime? AddedAt,DateTime? UpdatedAt)
	    {
	    ...
	    public void Update(Guid Id,Guid StationID,Guid InstrumentID,string StartDate,string EndDate,Guid UserId,DateTime? AddedAt,DateTime? UpdatedAt)
	    {
		    StationInstrument item = new StationInstrument();
	        item.MarkOld();
	        item.IsLoaded = true;
