...
{
	/// <summary>
	/// Strongly-typed collection for the StationProject class.
	/// </summary>
    [Serializable]
	public partial class StationProjectCollection : ActiveList<StationProject, StationProjectCollection>
	{	   
		public StationProjectCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>StationProjectCollection</returns>
		public StationProjectCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                StationProject o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the Station_Project table.
	/// </summary>
	[Serializable]
	public partial class StationProject : ActiveRecord<StationProject>, IActiveRecord
	{
		...
		public StationProject(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public StationProject(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public StationProject(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Station_Project", TableType.Table, DataService.GetInstance("ObservationsDB"));
				...
				DataService.Providers["ObservationsDB"].AddSchema("Station_Project",schema);
			}
		}
		#endregion
		...
		/// <summary>
		/// Returns a AspnetUser ActiveRecord object related to this StationProject
		/// 
		/// </summary>
		...
		/// <summary>
		/// Returns a Project ActiveRecord object related to this StationProject
		/// 
		/// </summary>
		...
		/// <summary>
		/// Returns a Station ActiveRecord object related to this StationProject
		/// 
		/// </summary>
		...
		/// </summary>
		public static void Insert(Guid varId,Guid varStationID,Guid varProjectID,DateTime? varStartDate,DateTime? varEndDate,Guid varUserId,DateTime? varAddedAt,DateTime? varUpdatedAt)
		{
		...
		/// </summary>
		public static void Update(Guid varId,Guid varStationID,Guid varProjectID,DateTime? varStartDate,DateTime? varEndDate,Guid varUserId,DateTime? varAddedAt,DateTime? varUpdatedAt)
		{
			StationProject item = new StationProject();
