...
namespace SAEON.Observations.Data
{
    ...
    public partial class SchemaColumnController
    {
	    ...
	    public void Insert(Guid Id,Guid DataSchemaID,int Number,string Name,Guid SchemaColumnTypeID,int? Width,string Format,Guid? PhenomenonID,Guid? PhenomenonOfferingID,Guid? PhenomenonUOMID,string EmptyValue,int? FixedTime,Guid UserId,DateTime? AddedAt,DateTime? UpdatedAt)
	    {
	    ...
	    public void Update(Guid Id,Guid DataSchemaID,int Number,string Name,Guid SchemaColumnTypeID,int? Width,string Format,Guid? PhenomenonID,Guid? PhenomenonOfferingID,Guid? PhenomenonUOMID,string EmptyValue,int? FixedTime,Guid UserId,DateTime? AddedAt,DateTime? UpdatedAt)
	    {
		    SchemaColumn item = new SchemaColumn();
	        item.MarkOld();
	        item.IsLoaded = true;
