...
{
	/// <summary>
	/// Strongly-typed collection for the ProjectStation class.
	/// </summary>
    [Serializable]
	public partial class ProjectStationCollection : ActiveList<ProjectStation, ProjectStationCollection>
	{	   
		public ProjectStationCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>ProjectStationCollection</returns>
		public ProjectStationCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                ProjectStation o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the Project_Station table.
	/// </summary>
	[Serializable]
	public partial class ProjectStation : ActiveRecord<ProjectStation>, IActiveRecord
	{
		...
		public ProjectStation(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public ProjectStation(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public ProjectStation(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Project_Station", TableType.Table, DataService.GetInstance("ObservationsDB"));
				...
				DataService.Providers["ObservationsDB"].AddSchema("Project_Station",schema);
			}
		}
		#endregion
		...
		/// </summary>
		public static void Insert(Guid varId,Guid varProjectID,Guid varStationID,DateTime? varStartDate,DateTime? varEndDate,Guid varUserId,DateTime? varAddedAt,DateTime? varUpdatedAt,byte[] varRowVersion)
		{
		...
		/// </summary>
		public static void Update(Guid varId,Guid varProjectID,Guid varStationID,DateTime? varStartDate,DateTime? varEndDate,Guid varUserId,DateTime? varAddedAt,DateTime? varUpdatedAt,byte[] varRowVersion)
		{
			ProjectStation item = new ProjectStation();
