...
{
	/// <summary>
	/// Strongly-typed collection for the InstrumentOrganisation class.
	/// </summary>
    [Serializable]
	public partial class InstrumentOrganisationCollection : ActiveList<InstrumentOrganisation, InstrumentOrganisationCollection>
	{	   
		public InstrumentOrganisationCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>InstrumentOrganisationCollection</returns>
		public InstrumentOrganisationCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                InstrumentOrganisation o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the Instrument_Organisation table.
	/// </summary>
	[Serializable]
	public partial class InstrumentOrganisation : ActiveRecord<InstrumentOrganisation>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public InstrumentOrganisation()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public InstrumentOrganisation(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public InstrumentOrganisation(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public InstrumentOrganisation(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Instrument_Organisation", TableType.Table, DataService.GetInstance("ObservationsDB"));
				...
				DataService.Providers["ObservationsDB"].AddSchema("Instrument_Organisation",schema);
			}
		}
		#endregion
		...
		/// <summary>
		/// Returns a AspnetUser ActiveRecord object related to this InstrumentOrganisation
		/// 
		/// </summary>
		...
		/// <summary>
		/// Returns a Instrument ActiveRecord object related to this InstrumentOrganisation
		/// 
		/// </summary>
		...
		/// <summary>
		/// Returns a Organisation ActiveRecord object related to this InstrumentOrganisation
		/// 
		/// </summary>
		...
		/// <summary>
		/// Returns a OrganisationRole ActiveRecord object related to this InstrumentOrganisation
		/// 
		/// </summary>
		...
		/// </summary>
		public static void Insert(Guid varId,Guid varInstrumentID,Guid varOrganisationID,Guid varOrganisationRoleID,DateTime? varStartDate,DateTime? varEndDate,Guid varUserId,DateTime? varAddedAt,DateTime? varUpdatedAt)
		{
			InstrumentOrganisation item = new InstrumentOrganisation();
		...
		/// </summary>
		public static void Update(Guid varId,Guid varInstrumentID,Guid varOrganisationID,Guid varOrganisationRoleID,DateTime? varStartDate,DateTime? varEndDate,Guid varUserId,DateTime? varAddedAt,DateTime? varUpdatedAt)
		{
			InstrumentOrganisation item = new InstrumentOrganisation();
