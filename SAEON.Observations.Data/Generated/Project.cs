...
namespace SAEON.Observations.Data
{
	...
	public partial class Project : ActiveRecord<Project>, IActiveRecord
	{
		...
		/// </summary>
		public static void Insert(Guid varId,Guid? varProgrammeID,string varCode,string varName,string varDescription,string varUrl,string varStartDate,string varEndDate,Guid varUserId,DateTime? varAddedAt,DateTime? varUpdatedAt)
		{
		...
		/// </summary>
		public static void Update(Guid varId,Guid? varProgrammeID,string varCode,string varName,string varDescription,string varUrl,string varStartDate,string varEndDate,Guid varUserId,DateTime? varAddedAt,DateTime? varUpdatedAt)
		{
			Project item = new Project();
