...
namespace SAEON.Observations.Data
{
    ...
    public partial class OrganisationStationController
    {
	    ...
	    public void Insert(Guid Id,Guid OrganisationID,Guid StationID,Guid OrganisationRoleID,string StartDate,string EndDate,Guid UserId,DateTime? AddedAt,DateTime? UpdatedAt)
	    {
	    ...
	    public void Update(Guid Id,Guid OrganisationID,Guid StationID,Guid OrganisationRoleID,string StartDate,string EndDate,Guid UserId,DateTime? AddedAt,DateTime? UpdatedAt)
	    {
		    OrganisationStation item = new OrganisationStation();
	        item.MarkOld();
	        item.IsLoaded = true;
