...
namespace SAEON.Observations.Data
{
    ...
    public partial class OrganisationSiteController
    {
	    ...
	    public void Insert(Guid Id,Guid OrganisationID,Guid SiteID,Guid OrganisationRoleID,DateTime? StartDate,DateTime? EndDate,Guid UserId,DateTime? AddedAt,DateTime? UpdatedAt,byte[] RowVersion)
	    {
	    ...
	    public void Update(Guid Id,Guid OrganisationID,Guid SiteID,Guid OrganisationRoleID,DateTime? StartDate,DateTime? EndDate,Guid UserId,DateTime? AddedAt,DateTime? UpdatedAt,byte[] RowVersion)
	    {
		    OrganisationSite item = new OrganisationSite();
	        item.MarkOld();
	        item.IsLoaded = true;
