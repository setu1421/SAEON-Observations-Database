...
namespace SAEON.Observations.Data{
    /// <summary>
    /// Strongly-typed collection for the VInventoryOrganisation class.
    /// </summary>
    [Serializable]
    public partial class VInventoryOrganisationCollection : ReadOnlyList<VInventoryOrganisation, VInventoryOrganisationCollection>
    {        
        public VInventoryOrganisationCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the vInventoryOrganisations view.
    /// </summary>
    [Serializable]
    public partial class VInventoryOrganisation : ReadOnlyRecord<VInventoryOrganisation>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("vInventoryOrganisations", TableType.View, DataService.GetInstance("ObservationsDB"));
                ...
                colvarSurrogateKey.IsNullable = true;
                ...
                DataService.Providers["ObservationsDB"].AddSchema("vInventoryOrganisations",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public VInventoryOrganisation()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public VInventoryOrganisation(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public VInventoryOrganisation(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public VInventoryOrganisation(string columnName, object columnValue)
        {
            SetSQLProps();
