...
namespace SAEON.Observations.Data
{
    ...
    public partial class PhenomenonUOMController
    {
	    ...
	    public void Insert(Guid Id,Guid PhenomenonID,Guid UnitOfMeasureID,bool IsDefault,Guid? UserId,DateTime? AddedAt,DateTime? UpdatedAt,byte[] RowVersion)
	    {
	    ...
	    public void Update(Guid Id,Guid PhenomenonID,Guid UnitOfMeasureID,bool IsDefault,Guid? UserId,DateTime? AddedAt,DateTime? UpdatedAt,byte[] RowVersion)
	    {
		    PhenomenonUOM item = new PhenomenonUOM();
	        item.MarkOld();
	        item.IsLoaded = true;
