...
namespace SAEON.Observations.Data
{
	...
	public partial class DataSource : ActiveRecord<DataSource>, IActiveRecord
	{
		...
		{
			return new SAEON.Observations.Data.DataSourceRoleCollection().Where(DataSourceRole.Columns.DataSourceID, Id).Load();
		}
		...
		{
			return new SAEON.Observations.Data.ImportBatchCollection().Where(ImportBatch.Columns.DataSourceID, Id).Load();
		}
		public SAEON.Observations.Data.InstrumentDataSourceCollection InstrumentDataSourceRecords()
		{
			return new SAEON.Observations.Data.InstrumentDataSourceCollection().Where(InstrumentDataSource.Columns.DataSourceID, Id).Load();
		}
		public SAEON.Observations.Data.SensorCollection SensorRecords()
		{
			return new SAEON.Observations.Data.SensorCollection().Where(Sensor.Columns.DataSourceID, Id).Load();
		}
		#endregion
		...
		/// </summary>
		public static void Insert(Guid varId,string varCode,string varName,string varDescription,string varUrl,double? varDefaultNullValue,double? varErrorEstimate,int varUpdateFreq,Date? varStartDate,Date? varEndDate,DateTime varLastUpdate,Guid? varDataSchemaID,Guid varUserId,DateTime? varAddedAt,DateTime? varUpdatedAt)
		{
		...
		/// </summary>
		public static void Update(Guid varId,string varCode,string varName,string varDescription,string varUrl,double? varDefaultNullValue,double? varErrorEstimate,int varUpdateFreq,Date? varStartDate,Date? varEndDate,DateTime varLastUpdate,Guid? varDataSchemaID,Guid varUserId,DateTime? varAddedAt,DateTime? varUpdatedAt)
		{
			DataSource item = new DataSource();
