...
//			get { return SAEON.Observations.Data.Station.FetchByID(this.StationID); }  
		...
		/// </summary>
		public static void Insert(Guid varId,Guid varStationID,Guid varInstrumentID,DateTime? varStartDate,DateTime? varEndDate,double? varLatitude,double? varLongitude,double? varElevation,Guid varUserId,DateTime? varAddedAt,DateTime? varUpdatedAt,byte[] varRowVersion)
		{
		...
		/// </summary>
		public static void Update(Guid varId,Guid varStationID,Guid varInstrumentID,DateTime? varStartDate,DateTime? varEndDate,double? varLatitude,double? varLongitude,double? varElevation,Guid varUserId,DateTime? varAddedAt,DateTime? varUpdatedAt,byte[] varRowVersion)
		{
			StationInstrument item = new StationInstrument();
