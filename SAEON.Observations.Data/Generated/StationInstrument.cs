...
namespace SAEON.Observations.Data
{
	...
	public partial class StationInstrument : ActiveRecord<StationInstrument>, IActiveRecord
	{
		...
		/// </summary>
		public static void Insert(Guid varId,Guid varStationID,Guid varInstrumentID,string varStartDate,string varEndDate,Guid varUserId,DateTime? varAddedAt,DateTime? varUpdatedAt)
		{
		...
		/// </summary>
		public static void Update(Guid varId,Guid varStationID,Guid varInstrumentID,string varStartDate,string varEndDate,Guid varUserId,DateTime? varAddedAt,DateTime? varUpdatedAt)
		{
			StationInstrument item = new StationInstrument();
