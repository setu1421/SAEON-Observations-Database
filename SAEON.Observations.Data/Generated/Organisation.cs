...
//			get { return SAEON.Observations.Data.AspnetUser.FetchByID(this.UserId); }  
		...
		/// <summary>
		/// Returns a DigitalObjectIdentifier ActiveRecord object related to this Organisation
		/// 
		/// </summary>
...
//			get { return SAEON.Observations.Data.DigitalObjectIdentifier.FetchByID(this.DigitalObjectIdentifierID); }  
		...
		/// </summary>
		public static void Insert(Guid varId,string varCode,string varName,string varDescription,string varUrl,Guid varUserId,DateTime? varAddedAt,DateTime? varUpdatedAt,byte[] varRowVersion,int? varDigitalObjectIdentifierID)
		{
		...
		/// </summary>
		public static void Update(Guid varId,string varCode,string varName,string varDescription,string varUrl,Guid varUserId,DateTime? varAddedAt,DateTime? varUpdatedAt,byte[] varRowVersion,int? varDigitalObjectIdentifierID)
		{
			Organisation item = new Organisation();
