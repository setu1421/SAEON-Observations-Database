...
namespace SAEON.Observations.Data{
    /// <summary>
    /// Strongly-typed collection for the VObservationRolesOld class.
    /// </summary>
    [Serializable]
    public partial class VObservationRolesOldCollection : ReadOnlyList<VObservationRolesOld, VObservationRolesOldCollection>
    {        
        public VObservationRolesOldCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the vObservationRolesOld view.
    /// </summary>
    [Serializable]
    public partial class VObservationRolesOld : ReadOnlyRecord<VObservationRolesOld>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("vObservationRolesOld", TableType.View, DataService.GetInstance("ObservationsDB"));
                ...
                DataService.Providers["ObservationsDB"].AddSchema("vObservationRolesOld",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public VObservationRolesOld()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public VObservationRolesOld(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public VObservationRolesOld(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public VObservationRolesOld(string columnName, object columnValue)
        {
            SetSQLProps();
