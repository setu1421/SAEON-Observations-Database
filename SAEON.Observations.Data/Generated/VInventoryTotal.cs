...
namespace SAEON.Observations.Data{
    /// <summary>
    /// Strongly-typed collection for the VInventoryTotal class.
    /// </summary>
    [Serializable]
    public partial class VInventoryTotalCollection : ReadOnlyList<VInventoryTotal, VInventoryTotalCollection>
    {        
        public VInventoryTotalCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the vInventoryTotals view.
    /// </summary>
    [Serializable]
    public partial class VInventoryTotal : ReadOnlyRecord<VInventoryTotal>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("vInventoryTotals", TableType.View, DataService.GetInstance("ObservationsDB"));
                ...
                colvarSurrogateKey.MaxLength = 150;
                ...
                DataService.Providers["ObservationsDB"].AddSchema("vInventoryTotals",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public VInventoryTotal()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public VInventoryTotal(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public VInventoryTotal(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public VInventoryTotal(string columnName, object columnValue)
        {
            SetSQLProps();
