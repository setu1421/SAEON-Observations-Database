...
namespace SAEON.Observations.Data{
    /// <summary>
    /// Strongly-typed collection for the VStationProject class.
    /// </summary>
    [Serializable]
    public partial class VStationProjectCollection : ReadOnlyList<VStationProject, VStationProjectCollection>
    {        
        public VStationProjectCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the vStationProject view.
    /// </summary>
    [Serializable]
    public partial class VStationProject : ReadOnlyRecord<VStationProject>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("vStationProject", TableType.View, DataService.GetInstance("ObservationsDB"));
                ...
                DataService.Providers["ObservationsDB"].AddSchema("vStationProject",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public VStationProject()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public VStationProject(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public VStationProject(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public VStationProject(string columnName, object columnValue)
        {
            SetSQLProps();
