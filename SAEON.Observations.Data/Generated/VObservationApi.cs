...
namespace SAEON.Observations.Data{
    /// <summary>
    /// Strongly-typed collection for the VObservationApi class.
    /// </summary>
    [Serializable]
    public partial class VObservationApiCollection : ReadOnlyList<VObservationApi, VObservationApiCollection>
    {        
        public VObservationApiCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the vObservationApi view.
    /// </summary>
    [Serializable]
    public partial class VObservationApi : ReadOnlyRecord<VObservationApi>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("vObservationApi", TableType.View, DataService.GetInstance("ObservationsDB"));
                ...
                DataService.Providers["ObservationsDB"].AddSchema("vObservationApi",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public VObservationApi()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public VObservationApi(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public VObservationApi(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public VObservationApi(string columnName, object columnValue)
        {
            SetSQLProps();
