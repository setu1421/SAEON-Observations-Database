...
{
	/// <summary>
	/// Strongly-typed collection for the Status class.
	/// </summary>
    [Serializable]
	...
	{	   
		...
		public StatusCollection Filter()
        {
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the Status table.
	/// </summary>
	[Serializable]
	public partial class Status : ActiveRecord<Status>, IActiveRecord
	{
		...
		public Status(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public Status(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Status", TableType.Table, DataService.GetInstance("ObservationsDB"));
				...
				DataService.Providers["ObservationsDB"].AddSchema("Status",schema);
			}
		}
		#endregion
		...
		/// <summary>
		/// Returns a AspnetUser ActiveRecord object related to this Status
		/// 
		/// </summary>
