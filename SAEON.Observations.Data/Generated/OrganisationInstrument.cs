...
namespace SAEON.Observations.Data
{
	...
	public partial class OrganisationInstrument : ActiveRecord<OrganisationInstrument>, IActiveRecord
	{
		...
		/// </summary>
		public static void Insert(Guid varId,Guid varOrganisationID,Guid varInstrumentID,Guid varOrganisationRoleID,DateTime? varStartDate,DateTime? varEndDate,Guid varUserId,DateTime? varAddedAt,DateTime? varUpdatedAt,byte[] varRowVersion)
		{
		...
		/// </summary>
		public static void Update(Guid varId,Guid varOrganisationID,Guid varInstrumentID,Guid varOrganisationRoleID,DateTime? varStartDate,DateTime? varEndDate,Guid varUserId,DateTime? varAddedAt,DateTime? varUpdatedAt,byte[] varRowVersion)
		{
			OrganisationInstrument item = new OrganisationInstrument();
