...
namespace SAEON.Observations.Data
{
	...
	public partial class OrganisationInstrument : ActiveRecord<OrganisationInstrument>, IActiveRecord
	{
		...
		/// </summary>
		public static void Insert(Guid varId,Guid varOrganisationID,Guid varInstrumentID,Guid varOrganisationRoleID,Date? varStartDate,Date? varEndDate,Guid varUserId,DateTime? varAddedAt,DateTime? varUpdatedAt)
		{
		...
		/// </summary>
		public static void Update(Guid varId,Guid varOrganisationID,Guid varInstrumentID,Guid varOrganisationRoleID,Date? varStartDate,Date? varEndDate,Guid varUserId,DateTime? varAddedAt,DateTime? varUpdatedAt)
		{
			OrganisationInstrument item = new OrganisationInstrument();
