...
namespace SAEON.Observations.Data
{
	...
	public partial class OrganisationSite : ActiveRecord<OrganisationSite>, IActiveRecord
	{
		...
		/// </summary>
		public static void Insert(Guid varId,Guid varOrganisationID,Guid varSiteID,Guid varOrganisationRoleID,Date? varStartDate,Date? varEndDate,Guid varUserId,DateTime? varAddedAt,DateTime? varUpdatedAt)
		{
		...
		/// </summary>
		public static void Update(Guid varId,Guid varOrganisationID,Guid varSiteID,Guid varOrganisationRoleID,Date? varStartDate,Date? varEndDate,Guid varUserId,DateTime? varAddedAt,DateTime? varUpdatedAt)
		{
			OrganisationSite item = new OrganisationSite();
