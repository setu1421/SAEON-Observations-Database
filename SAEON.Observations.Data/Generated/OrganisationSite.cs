...
{
	/// <summary>
	/// Strongly-typed collection for the OrganisationSite class.
	/// </summary>
    [Serializable]
	public partial class OrganisationSiteCollection : ActiveList<OrganisationSite, OrganisationSiteCollection>
	{	   
		public OrganisationSiteCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>OrganisationSiteCollection</returns>
		public OrganisationSiteCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                OrganisationSite o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the Organisation_Site table.
	/// </summary>
	[Serializable]
	public partial class OrganisationSite : ActiveRecord<OrganisationSite>, IActiveRecord
	{
		...
		public OrganisationSite(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public OrganisationSite(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public OrganisationSite(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Organisation_Site", TableType.Table, DataService.GetInstance("ObservationsDB"));
				...
				DataService.Providers["ObservationsDB"].AddSchema("Organisation_Site",schema);
			}
		}
		#endregion
		...
		/// </summary>
		public static void Insert(Guid varId,Guid varOrganisationID,Guid varSiteID,Guid varOrganisationRoleID,DateTime? varStartDate,DateTime? varEndDate,Guid varUserId,DateTime? varAddedAt,DateTime? varUpdatedAt,byte[] varRowVersion)
		{
		...
		/// </summary>
		public static void Update(Guid varId,Guid varOrganisationID,Guid varSiteID,Guid varOrganisationRoleID,DateTime? varStartDate,DateTime? varEndDate,Guid varUserId,DateTime? varAddedAt,DateTime? varUpdatedAt,byte[] varRowVersion)
		{
			OrganisationSite item = new OrganisationSite();
