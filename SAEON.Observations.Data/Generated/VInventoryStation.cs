...
namespace SAEON.Observations.Data{
    /// <summary>
    /// Strongly-typed collection for the VInventoryStation class.
    /// </summary>
    [Serializable]
    public partial class VInventoryStationCollection : ReadOnlyList<VInventoryStation, VInventoryStationCollection>
    {        
        public VInventoryStationCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the vInventoryStations view.
    /// </summary>
    [Serializable]
    public partial class VInventoryStation : ReadOnlyRecord<VInventoryStation>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("vInventoryStations", TableType.View, DataService.GetInstance("ObservationsDB"));
                ...
                DataService.Providers["ObservationsDB"].AddSchema("vInventoryStations",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public VInventoryStation()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public VInventoryStation(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public VInventoryStation(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public VInventoryStation(string columnName, object columnValue)
        {
            SetSQLProps();
