...
namespace SAEON.Observations.Data{
    /// <summary>
    /// Strongly-typed collection for the VInventoryYear class.
    /// </summary>
    [Serializable]
    public partial class VInventoryYearCollection : ReadOnlyList<VInventoryYear, VInventoryYearCollection>
    {        
        public VInventoryYearCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the vInventoryYears view.
    /// </summary>
    [Serializable]
    public partial class VInventoryYear : ReadOnlyRecord<VInventoryYear>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("vInventoryYears", TableType.View, DataService.GetInstance("ObservationsDB"));
                ...
                colvarSurrogateKey.MaxLength = 161;
                ...
                DataService.Providers["ObservationsDB"].AddSchema("vInventoryYears",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public VInventoryYear()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public VInventoryYear(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public VInventoryYear(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public VInventoryYear(string columnName, object columnValue)
        {
            SetSQLProps();
