...
namespace SAEON.Observations.Data
{
	...
	public partial class InstrumentSensor : ActiveRecord<InstrumentSensor>, IActiveRecord
	{
		...
		/// </summary>
		public static void Insert(Guid varId,Guid varInstrumentID,Guid varSensorID,string varStartDate,string varEndDate,Guid varUserId,DateTime? varAddedAt,DateTime? varUpdatedAt)
		{
		...
		/// </summary>
		public static void Update(Guid varId,Guid varInstrumentID,Guid varSensorID,string varStartDate,string varEndDate,Guid varUserId,DateTime? varAddedAt,DateTime? varUpdatedAt)
		{
			InstrumentSensor item = new InstrumentSensor();
