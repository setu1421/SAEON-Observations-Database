...
namespace SAEON.Observations.Data
{
	...
	public partial class DataSchema : ActiveRecord<DataSchema>, IActiveRecord
	{
		...
		{
			return new SAEON.Observations.Data.DataSourceCollection().Where(DataSource.Columns.DataSchemaID, Id).Load();
		}
		public SAEON.Observations.Data.SchemaColumnCollection SchemaColumnRecords()
		{
			return new SAEON.Observations.Data.SchemaColumnCollection().Where(SchemaColumn.Columns.DataSchemaID, Id).Load();
		}
		public SAEON.Observations.Data.SensorCollection SensorRecords()
		{
			return new SAEON.Observations.Data.SensorCollection().Where(Sensor.Columns.DataSchemaID, Id).Load();
		}
		#endregion
...
//			get { return SAEON.Observations.Data.AspnetUser.FetchByID(this.UserId); }  
        ...
        private SAEON.Observations.Data.DataSourceType _DataSourceType = null;
		/// <summary>
		/// Returns a DataSourceType ActiveRecord object related to this DataSchema
		/// 
		/// </summary>
		public SAEON.Observations.Data.DataSourceType DataSourceType
		{
//			get { return SAEON.Observations.Data.DataSourceType.FetchByID(this.DataSourceTypeID); }  
			get { return _DataSourceType ?? (_DataSourceType = SAEON.Observations.Data.DataSourceType.FetchByID(this.DataSourceTypeID)); }
