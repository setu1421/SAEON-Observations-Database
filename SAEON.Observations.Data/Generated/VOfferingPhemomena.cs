...
namespace SAEON.Observations.Data{
    /// <summary>
    /// Strongly-typed collection for the VOfferingPhemomena class.
    /// </summary>
    [Serializable]
    public partial class VOfferingPhemomenaCollection : ReadOnlyList<VOfferingPhemomena, VOfferingPhemomenaCollection>
    {        
        public VOfferingPhemomenaCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the vOfferingPhemomena view.
    /// </summary>
    [Serializable]
    public partial class VOfferingPhemomena : ReadOnlyRecord<VOfferingPhemomena>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("vOfferingPhemomena", TableType.View, DataService.GetInstance("ObservationsDB"));
                ...
                DataService.Providers["ObservationsDB"].AddSchema("vOfferingPhemomena",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public VOfferingPhemomena()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public VOfferingPhemomena(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public VOfferingPhemomena(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public VOfferingPhemomena(string columnName, object columnValue)
        {
            SetSQLProps();
