...
namespace SAEON.Observations.Data
{
    ...
    public partial class InstrumentController
    {
	    ...
	    public void Insert(Guid Id,string Code,string Name,string Description,string Url,DateTime? StartDate,DateTime? EndDate,double? Latitude,double? Longitude,double? Elevation,Guid UserId,DateTime? AddedAt,DateTime? UpdatedAt,byte[] RowVersion)
	    {
	    ...
	    public void Update(Guid Id,string Code,string Name,string Description,string Url,DateTime? StartDate,DateTime? EndDate,double? Latitude,double? Longitude,double? Elevation,Guid UserId,DateTime? AddedAt,DateTime? UpdatedAt,byte[] RowVersion)
	    {
		    Instrument item = new Instrument();
	        item.MarkOld();
	        item.IsLoaded = true;
