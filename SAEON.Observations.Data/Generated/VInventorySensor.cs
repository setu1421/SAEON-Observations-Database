...
namespace SAEON.Observations.Data{
    /// <summary>
    /// Strongly-typed collection for the VInventorySensor class.
    /// </summary>
    [Serializable]
    public partial class VInventorySensorCollection : ReadOnlyList<VInventorySensor, VInventorySensorCollection>
    {        
        public VInventorySensorCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the vInventorySensors view.
    /// </summary>
    [Serializable]
    public partial class VInventorySensor : ReadOnlyRecord<VInventorySensor>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("vInventorySensors", TableType.View, DataService.GetInstance("ObservationsDB"));
                ...
                DataService.Providers["ObservationsDB"].AddSchema("vInventorySensors",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public VInventorySensor()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public VInventorySensor(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public VInventorySensor(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public VInventorySensor(string columnName, object columnValue)
        {
            SetSQLProps();
