...
namespace SAEON.Observations.Data
{
    ...
    public partial class UnitOfMeasureController
    {
	    ...
	    public void Insert(Guid Id,string Code,string Unit,string UnitSymbol,Guid UserId,DateTime? AddedAt,DateTime? UpdatedAt,byte[] RowVersion)
	    {
	    ...
	    public void Update(Guid Id,string Code,string Unit,string UnitSymbol,Guid UserId,DateTime? AddedAt,DateTime? UpdatedAt,byte[] RowVersion)
	    {
		    UnitOfMeasure item = new UnitOfMeasure();
	        item.MarkOld();
	        item.IsLoaded = true;
